...
do
	git submodule add -f --depth=1 https://github.com/boostorg/$i.git
...
git submodule add -f --depth=1 https://github.com/boostorg/numeric_conversion.git conversion
git config -f ../../../.gitmodules submodule.contrib/boost/numeric/conversion.shallow true

git submodule add -f --depth=1 https://github.com/boostorg/interval.git
git config -f ../../../.gitmodules submodule.contrib/boost/numeric/interval.shallow true

git submodule add -f --depth=1 https://github.com/boostorg/odeint.git
git config -f ../../../.gitmodules submodule.contrib/boost/numeric/odeint.shallow true

git submodule add -f --depth=1 https://github.com/boostorg/ublas.git
