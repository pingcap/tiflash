...
pub mod root {
    pub mod DB {
        ...
        #[repr(u8)]
        #[derive(Debug, Clone, Hash, PartialEq, Eq)]
        pub enum ColumnarReaderErrorType {
            OK = 0,
            RegionError = 1,
            LockedError = 2,
            PdClientError = 3,
        ...
        #[repr(C)]
        #[derive(Debug)]
        pub struct ColumnarReaderPtr {
            pub inner: root::DB::RawRustPtr,
            pub error: root::DB::RustStrWithView,
            pub error_type: root::DB::ColumnarReaderErrorType,
        }
        #[repr(C)]
        #[derive(Debug)]
        ...
        pub struct CloudStorageEngineInterfaces {
            ...
            pub fn_get_columnar_reader: ::std::option::Option<
                unsafe extern "C" fn(
                    ...
                    arg3: u64,
                    arg4: root::DB::BaseBuffView,
                    arg5: root::DB::BaseBuffView,
                    arg6: root::DB::BaseBuffView,
            ...
            pub fn_read_block: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::DB::ColumnarReaderPtr, arg2: u64) -> u64,
            >,
            pub fn_read_handle: ::std::option::Option<
                unsafe extern "C" fn(
                    arg1: root::DB::ColumnarReaderPtr,
                ) -> root::DB::RustStrWithView,
            >,
            pub fn_read_version: ::std::option::Option<
                unsafe extern "C" fn(
                    arg1: root::DB::ColumnarReaderPtr,
                ) -> root::DB::RustStrWithView,
            >,
            pub fn_read_column: ::std::option::Option<
                unsafe extern "C" fn(
                    arg1: root::DB::ColumnarReaderPtr,
                    arg2: i64,
                ) -> root::DB::RustStrWithView,
