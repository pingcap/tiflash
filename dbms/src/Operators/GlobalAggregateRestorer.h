...
class GlobalAggregateRestorer : public std::enable_shared_from_this<GlobalAggregateRestorer>
{
public:
    GlobalAggregateRestorer(
...
private:
    ...
    std::vector<BlocksList> bucket_data;
    std::vector<BlocksList> restored_blocks;
...
using GlobalAggregateRestorerPtr = std::unique_ptr<GlobalAggregateRestorer>;
} // namespace DB
