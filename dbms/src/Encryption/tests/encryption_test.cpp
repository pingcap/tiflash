...
const unsigned char TEST_KEY[33] =
...
class EncryptionTest
 ...
 public:
  ...
  bool TestEncryption(size_t start, size_t end,
                      const unsigned char* iv = TEST_IV_RANDOM) {
