...
struct MockTiDBTable
{
    ...
    //   ./storages-client.sh "DBGInvoke mock_tidb_table(database_name, table_name, 'col1 type1, col2 type2, ...' [, handle_pk_name, engine-type(flash_ctx|dt)])"
    //   engine: [flash_ctx, dt], flash_ctx by default
