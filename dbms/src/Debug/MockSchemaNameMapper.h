...
struct MockSchemaNameMapper : public SchemaNameMapper
{
    ...
    String displayDatabaseName(const TiDB::DBInfo & db_info) const override { return db_info.name; }
    String mapTableName(const TiDB::TableInfo & table_info) const override { return table_info.name; }
    String displayTableName(const TiDB::TableInfo & table_info) const override { return table_info.name; }
