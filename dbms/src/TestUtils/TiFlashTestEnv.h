...
public:
    ...
    static void initializeGlobalContext(Strings testdata_path = {}, PageStorageRunMode ps_run_mode = PageStorageRunMode::UNI_PS, uint64_t bg_thread_count = 2);
    static void addGlobalContext(Strings testdata_path = {}, PageStorageRunMode ps_run_mode = PageStorageRunMode::UNI_PS, uint64_t bg_thread_count = 2);
