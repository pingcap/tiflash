...
namespace DB
{
    ...
    Block AggregateStore::getHeader() const { return aggregator.getHeader(is_final); }

    const Aggregator::Params & AggregateStore::getParams() const { return aggregator.getParams(); }
