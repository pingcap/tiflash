...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingDouble, pipeline_keyspace_cpu_limit_ratio, 0.8, "Maximum pipeline CPU-time share for one keyspace. CPU and IO tasks share the limit. 0 disables CPU-time limiting. Only has meaning at server startup.")                \
    M(SettingDouble, pipeline_keyspace_pool_limit_ratio, 0.8, "Maximum pipeline active-task share for one keyspace. CPU and IO tasks share the limit. 0 disables concurrent-task limiting. Only has meaning at server startup.")       \
