...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, no_copy_cross_probe_threshold, 1000000000, "minimum right rows to use no copy probe mode for cross join, default is max(1, max_block_size/10)")
