...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, join_v2_probe_enable_prefetch_threshold, 1024 * 1024, "minimum row number of join build table to use prefetch during join probe phase")                                                                            \
    M(SettingUInt64, join_v2_probe_prefetch_step, 16, "hash join probe prefetch length")                                                                                                                                                \
    M(SettingUInt64, join_v2_probe_insert_batch_size, 128, "hash join probe insert batch size")
