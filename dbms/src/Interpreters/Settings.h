...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingDouble, pipeline_keyspace_cpu_limit_ratio, 0.8, "Maximum pipeline CPU-time share for one keyspace. CPU and IO tasks share the limit. 0 disables the keyspace fallback limit. Only has meaning at server startup.")       \
