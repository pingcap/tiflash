...
#define APPLY_FOR_SETTINGS(M) \
    ...
    M(SettingUInt64, cpu_affinity_read_percent, 0, "About (total_cpu_cores * cpu_affinity_read_percent / 100) logical CPU cores are used for handle read requests. Zero means unlimited.")
