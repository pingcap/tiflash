...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, resource_control_mpptask_hard_limit, 5000, "The hard limit count of active mpp task of all resource groups when resource control is enabled.")                                                                     \
