...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, dt_small_file_size_threshold, 16 * 1024, "for dmfile, when the file size less than dt_small_file_size_threshold, it will be merged")                                                            \
    M(SettingDouble, dt_merged_file_max_size, 16 * 1024 * 1024, "Small files are merged into one or more files not larger than dt_merged_file_max_size")                                                                                     \
