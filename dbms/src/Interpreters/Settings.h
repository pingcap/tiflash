...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingFloat, dt_storage_pool_meta_gc_max_valid_rate, 0.35, "Max valid rate of deciding a page file can be compact")                                                                                                              \
                                                                                                                                                                                                                                        \
    M(SettingUInt64, dt_checksum_frame_size, DBMS_DEFAULT_BUFFER_SIZE, "Frame size for delta merge stable storage")                                                                                                                     \
    M(SettingChecksumAlgorithm, dm_checksum_algorithm, ChecksumAlgo::XXH3, "Checksum algorithm for default merge stable storage")                                                                                                       \
                                                                                                                                                                                                                                        \
