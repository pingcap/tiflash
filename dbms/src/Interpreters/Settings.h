...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, max_network_bandwidth_for_all_users, 0, "The maximum speed of data exchange over the network in bytes per second for all concurrently running queries. Zero means "                                                \
                                                             "unlimited.")                                                                                                                                                              \
    M(SettingUInt64, minTSO_scheduler_thread_soft_limit, 5000, "The soft limit of threads for minTSO scheduler.")                                                                                                                       \
    M(SettingUInt64, minTSO_scheduler_thread_hard_limit, 8000, "The hard limit of threads for minTSO scheduler.")                                                                                                                       \
