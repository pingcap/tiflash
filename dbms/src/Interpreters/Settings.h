...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, background_pool_size, 0, "Number of threads performing background work for tables (for example, merging in merge tree). Only has meaning at server "                               \
                                                                              "startup. 0 means a quarter of number of logical CPU cores of machine.")                                                                                                                                               \
                                                                                                                                                                                                                                        \
