...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingFloat, dt_page_gc_low_write_prob, 0.10, "Probability to run gc when write there is few writes.")                                                                                                                           \
                                                                                                                                                                                                                                        \
    M(SettingUInt64, dt_page_blob_file_limit_size, 512 * Constant::MB, "Max bytes of single blob file")                                                                                                                                 \
    M(SettingUInt64, dt_page_blob_cached_fd_size, 100, "Max numbers of blob fd been cached")                                                                                                                                            \
    M(SettingDouble, dt_page_blob_heavy_gc_valid_rate, 0.2, "Max valid rate of deciding a blob can be compact")                                                                                                                         \
    M(SettingUInt64, dt_page_wal_roll_size, 2 * Constant::MB, "Max bytes of deciding a wal log rolling")                                                                                                                                \
    M(SettingUInt64, dt_page_wal_recover_mode, 0, "The WALStore recover mode, optional=[0,3]")                                                                                                                                          \
    M(SettingUInt64, dt_page_wal_max_persisted_log_files, 4, "Max numbers of deciding wal logs can be compact")                                                                                                                         \
                                                                                                                                                                                                                                        \
    ...
    M(SettingFloat, dt_storage_pool_meta_gc_max_valid_rate, 0.35, "Max valid rate of deciding a page file can be compact")                                                                                                              \
                                                                                                                                                                                                                                        \
    M(SettingUInt64, dt_storage_pool_log_blob_file_limit_size, 512 * Constant::MB, "Max bytes of single blob file")                                                                                                                     \
    M(SettingUInt64, dt_storage_pool_log_blob_cached_fd_size, 100, "Max numbers of blob fd been cached")                                                                                                                                \
    M(SettingDouble, dt_storage_pool_log_blob_heavy_gc_valid_rate, 0.2, "Max valid rate of deciding a blob can be compact")                                                                                                             \
    M(SettingUInt64, dt_storage_pool_log_wal_roll_size, 2 * Constant::MB, "Max bytes of deciding a wal log rolling")                                                                                                                    \
    M(SettingUInt64, dt_storage_pool_log_wal_recover_mode, 0, "The WALStore recover mode, optional=[0,3]")                                                                                                                              \
    M(SettingUInt64, dt_storage_pool_log_wal_max_persisted_log_files, 4, "Max numbers of deciding wal logs can be compact")                                                                                                             \
                                                                                                                                                                                                                                        \
    M(SettingUInt64, dt_storage_pool_data_blob_file_limit_size, 512 * Constant::MB, "Max bytes of single blob file")                                                                                                                    \
    M(SettingUInt64, dt_storage_pool_data_blob_cached_fd_size, 100, "Max numbers of blob fd been cached")                                                                                                                               \
    M(SettingDouble, dt_storage_pool_data_blob_heavy_gc_valid_rate, 0.2, "Max valid rate of deciding a blob can be compact")                                                                                                            \
    M(SettingUInt64, dt_storage_pool_data_wal_roll_size, 2 * Constant::MB, "Max bytes of deciding a wal log rolling")                                                                                                                   \
    M(SettingUInt64, dt_storage_pool_data_wal_recover_mode, 0, "The WALStore recover mode, optional=[0,3]")                                                                                                                             \
    M(SettingUInt64, dt_storage_pool_data_wal_max_persisted_log_files, 4, "Max numbers of deciding wal logs can be compact")                                                                                                            \
                                                                                                                                                                                                                                        \
    M(SettingUInt64, dt_storage_pool_meta_blob_file_limit_size, 512 * Constant::MB, "Max bytes of single blob file")                                                                                                                    \
    M(SettingUInt64, dt_storage_pool_meta_blob_cached_fd_size, 100, "Max numbers of blob fd been cached")                                                                                                                               \
    M(SettingDouble, dt_storage_pool_meta_blob_heavy_gc_valid_rate, 0.2, "Max valid rate of deciding a blob can be compact")                                                                                                            \
    M(SettingUInt64, dt_storage_pool_meta_wal_roll_size, 2 * Constant::MB, "Max bytes of deciding a wal log rolling")                                                                                                                   \
    M(SettingUInt64, dt_storage_pool_meta_wal_recover_mode, 0, "The WALStore recover mode, optional=[0,3]")                                                                                                                             \
    M(SettingUInt64, dt_storage_pool_meta_wal_max_persisted_log_files, 4, "Max numbers of deciding wal logs can be compact")                                                                                                            \
                                                                                                                                                                                                                                        \
