...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, dt_enable_multi_stage_late_materialization, 2, "Multi-stage late materialization mode in DeltaTree Engine. 0: disabled, 1: selection only, 2: TopN enhanced.")                                                    \
