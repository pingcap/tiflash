...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingDouble, dt_storage_pool_log_gc_force_hardlink_rate, 0.2, "Max valid rate of deciding a page file can do hardlink")                                                                                                         \
                                                                                                                                                                                                                                        \
    ...
    M(SettingDouble, dt_storage_pool_data_gc_force_hardlink_rate, 0.2, "Max valid rate of deciding a page file can do hardlink")                                                                                                        \
                                                                                                                                                                                                                                        \
    ...
    M(SettingDouble, dt_storage_pool_meta_gc_force_hardlink_rate, 0.2, "Max valid rate of deciding a page file can do hardlink")                                                                                                        \
                                                                                                                                                                                                                                        \
