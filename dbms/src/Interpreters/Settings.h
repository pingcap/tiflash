...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, max_cached_data_bytes_in_spiller, 1024ULL * 1024 * 100, "Max cached data bytes in spiller before spilling, 100MB as the default value, 0 means +inf")                                                                                                   \
    M(SettingUInt64, max_spilled_rows_per_file, 200000, "Max spilled data rows per spill file, 200000 as the default value.")                                                                                                           \
    M(SettingUInt64, max_spilled_bytes_per_file, 1024ULL * 1024 * 1024, "Max spilled data bytes per spill file, 1GB as the default value.")                                                                                             \
                                                                                                                                                                                                                                        \
