...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, resource_control_mpptask_hard_limit, 5000, "The hard limit of count of active mpp task when resource control is enabled.")                                                                                         \
    M(SettingUInt64, resource_group_task_scheduler_thread_soft_limit, 5000, "The soft limit of threads for min_tso task scheduler.")                                                                                                    \
    M(SettingUInt64, resource_group_task_scheduler_thread_hard_limit, 10000, "The hard limit of threads for min_tso task scheduler.")                                                                                                   \
    M(SettingUInt64, resource_group_task_scheduler_active_set_soft_limit, 0, "The soft limit of count of active query set for min_tso task scheduler.")                                                                                 \
