...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, cop_pool_handle_limit, 0, "The maximum number of requests can be handled by cop pool, include executing and queuing tasks. More cop requests will get error \"TiFlash Server is Busy\". -1 means unlimited, 0 means determined automatically (10 times of cop-pool-size).") \
    M(SettingSeconds, cop_pool_max_queued_duration, 20, "The maximum queuing duration of coprocessor task. When task starts to run, it checks whether queued more than this config, is so, it will directly return error \"TiFlash Server is Busy\". <=0 means unlimited, default is 20s.")                                                                                                     \
