...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, dt_fetch_pages_max_packet_size, 0, "Response packet size limit of FetchDisaggPages, 0 means one page per packet")                                                                                                  \
    M(SettingUInt64, dt_write_page_cache_max_size, 2 * 1024 * 1024, "Max size per write batch when compute node writing to PageStorage cache")                                                                                          \
