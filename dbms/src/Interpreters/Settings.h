...
#define APPLY_FOR_SETTINGS(M)                                                                                                              \
    ...
    M(SettingUInt64, cop_pool_size, 0, "The number of threads in to handle cop requests. By default, it is determined automatically.")     \
    M(SettingUInt64, batch_cop_pool_size, 0,                                                                                               \
        "The number of threads in to handle batch requests. By default, it is determined automatically.")                                  \
