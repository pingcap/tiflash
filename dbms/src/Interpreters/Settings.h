...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, dt_segment_delta_small_pack_rows, 2048, "Determine whether a column file in delta is small or not.")                                                                                                                       \
    M(SettingUInt64, dt_segment_delta_small_pack_size, 8388608, "Determine whether a column file in delta is small or not. 8MB by default.")                                                                                                   \
