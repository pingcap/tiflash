...
#define APPLY_FOR_SETTINGS(M) \
    ...
    M(SettingInt64, dt_bg_gc_max_segments_to_check_every_round, 30, "Max segments to check in every gc round, value less than or equal to 0 means gc no segments.")\
