...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, background_pool_size, 0, "Number of threads performing background work for tables (for example, merging in merge tree). Only effective at server "                               \
                                                                              "startup. 0 means a quarter of the number of logical CPU cores of the machine.")                                                                                                                                               \
                                                                                                                                                                                                                                        \
    ...
    M(SettingUInt64, grpc_completion_queue_pool_size, 0, "The size of gRPC completion queue pool. 0 means number of logical CPU cores. Only effective at server startup")\
