...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingBool, use_uncompressed_cache, true, "(deprecated, no effect)")                                                                                                                                                             \
    ...
    M(SettingString, disagg_blocklist_wn_store_id, "", "comma separated unsigned integers representing `store_id`s of stores that are blacklisted.")                                                                                    \
