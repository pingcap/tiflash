...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingInt64, rn_protocal, 1, "!!!REMOVE IT!!! 0 - cop; 1 - batch cop")                                                                                                                                                  \
    M(SettingUInt64, rn_batch_cop_split, 1, "!!!REMOVE IT!!! split the batch cop task into smaller tasks, more grpc connections")                                                                                                       \
    M(SettingUInt64, rn_recv_buffer, 20, "!!!REMOVE IT!!! split the batch cop task into smaller tasks, more grpc connections")                                                                                                          \
    M(SettingUInt64, wn_send_buffer, 20, "!!!REMOVE IT!!! split the batch cop task into smaller tasks, more grpc connections")                                                                                                          \
