...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingMemoryLimit, max_memory_usage_for_all_queries, UInt64(0), "Maximum memory usage for processing all concurrently running queries on the server. Zero means unlimited.")                                                                  \
