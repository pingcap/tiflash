...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingDouble, s3_thread_count_scale, 5.0, "Number of thread of DataStoreS3Pool = number of logical cpu cores * s3_thread_count_scale.  Only has meaning at server startup.")                                                     \
                                                                                                                                                                                                                                        \
