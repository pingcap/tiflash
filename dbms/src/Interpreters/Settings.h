...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingBool, dt_enable_shared_rn_workers, true, "Whether to share fetching-page workers and preparing-stream worker between queries")                                                                                             \
    M(SettingInt64, dt_shared_max_queue_size, 163840, "Max task queue size of fetching-page workers and preparing-stream workers")                                                                                                      \
