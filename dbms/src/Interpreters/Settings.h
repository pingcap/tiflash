...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingCompressionMethod, dt_compression_method, CompressionMethod::LZ4, "Allows you to select the method of data compression when writing.")                                                                                     \
    M(SettingInt64, dt_compression_level, 1, "Allows you to select the compression level.")                                                                                                                                             \
