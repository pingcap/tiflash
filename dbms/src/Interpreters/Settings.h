...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingDouble, dt_filecache_download_scale, 2.0, "Max concurrency of download task count of FileCache = number of logical cpu cores * dt_filecache_download_scale.")                                                              \
