...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingInt64, remote_summary_interval_seconds, 24 * 60 * 60, "The interval of collecting remote S3 storage summary. Unit is second. <=0 disables periodic summary task.")                                                        \
