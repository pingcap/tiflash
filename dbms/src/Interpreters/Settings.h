...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, dt_segment_force_split_rows, 3000000, "The threshold of the foreground split segment. in DeltaTree Engine.")                                                                                                       \
    ...
    M(SettingUInt64, dt_segment_delta_small_pack_rows, 4096, "Determine whether a pack in delta is small or not.")                                                                                                                       \
