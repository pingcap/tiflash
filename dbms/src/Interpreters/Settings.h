...
#define APPLY_FOR_SETTINGS(M)                                                                                          \
    ...
    M(SettingInt64,                                                                                                    \
      ...
      DEFAULT_BATCH_SEND_MIN_LIMIT,                                                                                    \
      "default minimal chunk size of exchanging data among TiFlash.")                                                  \
    M(SettingInt64,                                                                                                    \
      batch_send_min_limit_compression,                                                                                \
      -1,                                                                                                              \
      "default minimal chunk size of exchanging data among TiFlash when using data compression.")                      \
    ...
    M(SettingUInt64,                                                                                                   \
      mpp_task_running_timeout,                                                                                        \
      DEFAULT_MPP_TASK_RUNNING_TIMEOUT,                                                                                \
      "mpp task max time that running without any progress.")                                                          \
    M(SettingUInt64,                                                                                                   \
      mpp_task_waiting_timeout,                                                                                        \
      DEFAULT_MPP_TASK_WAITING_TIMEOUT,                                                                                \
      "mpp task max time that waiting first data block from source input stream.")                                     \
    M(SettingUInt64,                                                                                                   \
      disagg_task_snapshot_timeout,                                                                                    \
      DEFAULT_DISAGG_TASK_TIMEOUT_SEC,                                                                                 \
      "disagg task max endurable time, unit is second.")                                                               \
    M(SettingInt64, safe_point_update_interval_seconds, 1, "The interval in seconds to update safe point from PD.")    \
    M(SettingUInt64,                                                                                                   \
      min_compress_block_size,                                                                                         \
      DEFAULT_MIN_COMPRESS_BLOCK_SIZE,                                                                                 \
      "The actual size of the block to compress, if the uncompressed data less than max_compress_block_size is no "    \
    ...
    M(SettingUInt64,                                                                                                   \
      cop_pool_size,                                                                                                   \
      0,                                                                                                               \
      "The number of threads to handle cop requests. By default, it is determined automatically.")                     \
    M(SettingInt64,                                                                                                    \
      cop_pool_handle_limit,                                                                                           \
      0,                                                                                                               \
      "The maximum number of requests can be handled by cop pool, include executing and queuing tasks. More cop "      \
      "requests will get error \"TiFlash Server is Busy\". -1 means unlimited, 0 means determined automatically (10 "  \
      "times of cop-pool-size).")                                                                                      \
    M(SettingInt64,                                                                                                    \
      cop_pool_max_queued_seconds,                                                                                     \
      15,                                                                                                              \
      "The maximum queuing duration of coprocessor task, unit is second. When task starts to run, it checks whether "  \
      "queued more than this config, if so, it will directly return error \"TiFlash Server is Busy\". <=0 means "      \
      "unlimited, default is 15. The upper limit of this config is 20.")                                               \
    M(SettingUInt64,                                                                                                   \
      batch_cop_pool_size,                                                                                             \
      0,                                                                                                               \
      "The number of threads to handle batch cop requests. By default, it is determined automatically.")               \
    M(SettingUInt64,                                                                                                   \
    ...
    M(SettingUInt64,                                                                                                   \
      ...
      DEFAULT_MAX_DISTRIBUTED_CONNECTIONS,                                                                             \
      "The maximum number of connections for distributed processing of one query (should be greater than "             \
      "max_threads).")                                                                                                 \
    M(SettingUInt64,                                                                                                   \
      max_query_size,                                                                                                  \
      DEFAULT_MAX_QUERY_SIZE,                                                                                          \
      "Which part of the query can be read into RAM for parsing (the remaining data for INSERT, if any, is read "      \
      "later)")                                                                                                        \
    M(SettingUInt64,                                                                                                   \
      interactive_delay,                                                                                               \
      DEFAULT_INTERACTIVE_DELAY,                                                                                       \
    ...
    M(SettingUInt64,                                                                                                   \
      ...
      DBMS_DEFAULT_BACKGROUND_POOL_SIZE,                                                                               \
      "Number of threads performing background work for tables (for example, merging in merge tree). Only has "        \
      "meaning at server "                                                                                             \
      "startup.")                                                                                                      \
                                                                                                                       \
    M(SettingBool,                                                                                                     \
      ...
      "Allows disabling WHERE to PREWHERE optimization in SELECT queries from MergeTree.")                             \
                                                                                                                       \
    M(SettingLoadBalancing,                                                                                            \
      load_balancing,                                                                                                  \
      LoadBalancing::RANDOM,                                                                                           \
      "Which replicas (among healthy replicas) to preferably send a query to (on the first attempt) for distributed "  \
      "processing.")                                                                                                   \
                                                                                                                       \
    M(SettingUInt64,                                                                                                   \
    ...
    M(SettingUInt64,                                                                                                   \
      ...
      100000000,                                                                                                       \
      "From what size of the aggregation state in bytes, a two-level aggregation begins to be used. 0 - the "          \
      "threshold is not set. "                                                                                         \
      "Two-level aggregation is used when at least one of the thresholds is triggered.")                               \
    M(SettingUInt64,                                                                                                   \
      aggregation_memory_efficient_merge_threads,                                                                      \
      0,                                                                                                               \
      "Number of threads to use for merge intermediate aggregation results in memory efficient mode. When bigger, "    \
      "then more memory is "                                                                                           \
    ...
    M(SettingFloat,                                                                                                    \
      ...
      0.,                                                                                                              \
      "For testing of `exception safety` - throw an exception every time you allocate memory with the specified "      \
      "probability.")                                                                                                  \
                                                                                                                       \
    M(SettingInt64,                                                                                                    \
      memory_tracker_accuracy_diff_for_test,                                                                           \
      0,                                                                                                               \
      "For testing of the accuracy of the memory tracker - throw an exception when real_rss is much larger than "      \
      "tracked amount.")                                                                                               \
                                                                                                                       \
    M(SettingString,                                                                                                   \
    ...
    M(SettingBool,                                                                                                     \
      ...
      true,                                                                                                            \
      "For Values format: if field could not be parsed by streaming parser, run SQL parser and try to interpret it "   \
      "as SQL expression.")                                                                                            \
                                                                                                                       \
    M(SettingBool,                                                                                                     \
    ...
    M(SettingBool,                                                                                                     \
      fsync_metadata,                                                                                                  \
      1,                                                                                                               \
      "Do fsync after changing metadata for tables and databases (.sql files). Could be disabled in case of poor "     \
      "latency on server "                                                                                             \
    ...
    M(SettingUInt64,                                                                                                   \
      readonly,                                                                                                        \
      0,                                                                                                               \
      "0 - everything is allowed. 1 - only read requests. 2 - only read requests, as well as changing settings, "      \
      "except for the "                                                                                                \
      "'readonly' setting.")                                                                                           \
                                                                                                                       \
    ...
    M(SettingUInt64,                                                                                                   \
      dt_segment_force_split_size,                                                                                     \
      1610612736,                                                                                                      \
      "The threshold of the foreground split segment. in DeltaTree Engine. 1.5GB by default.")                         \
    M(SettingUInt64, dt_segment_delta_limit_rows, 80000, "Max rows of segment delta in DeltaTree Engine")              \
    M(SettingUInt64,                                                                                                   \
      dt_segment_delta_limit_size,                                                                                     \
      42991616,                                                                                                        \
      "Max size of segment delta in DeltaTree Engine. 41 MB by default.")                                              \
    ...
    M(SettingUInt64,                                                                                                   \
      dt_segment_force_merge_delta_size,                                                                               \
      1073741824,                                                                                                      \
      "Delta size before force merge into stable. 1 GB by default.")                                                   \
    M(SettingUInt64, dt_segment_stop_write_delta_rows, 268435456, "Delta rows before stop new writes.")                \
    M(SettingUInt64,                                                                                                   \
      dt_segment_stop_write_delta_size,                                                                                \
      2147483648,                                                                                                      \
      "Delta size before stop new writes. 2 GB by default.")                                                           \
    M(SettingUInt64,                                                                                                   \
      dt_segment_delta_cache_limit_rows,                                                                               \
      4096,                                                                                                            \
      "Max rows of cache in segment delta in DeltaTree Engine.")                                                       \
    M(SettingUInt64,                                                                                                   \
      dt_segment_delta_cache_limit_size,                                                                               \
      4194304,                                                                                                         \
      "Max size of cache in segment delta in DeltaTree Engine. 4 MB by default.")                                      \
    M(SettingUInt64,                                                                                                   \
      dt_segment_delta_small_pack_rows,                                                                                \
      2048,                                                                                                            \
      "Deprecated. Reserved for backward compatibility. Use dt_segment_delta_small_column_file_rows instead")          \
    M(SettingUInt64,                                                                                                   \
      dt_segment_delta_small_pack_size,                                                                                \
      8388608,                                                                                                         \
      "Deprecated. Reserved for backward compatibility. Use dt_segment_delta_small_column_file_size instead")          \
    M(SettingUInt64,                                                                                                   \
      dt_segment_delta_small_column_file_rows,                                                                         \
      2048,                                                                                                            \
      "Determine whether a column file in delta is small or not. 8MB by default.")                                     \
    M(SettingUInt64,                                                                                                   \
      dt_segment_delta_small_column_file_size,                                                                         \
      8388608,                                                                                                         \
      "Determine whether a column file in delta is small or not. 8MB by default.")                                     \
    M(SettingUInt64,                                                                                                   \
      dt_segment_stable_pack_rows,                                                                                     \
      DEFAULT_MERGE_BLOCK_SIZE,                                                                                        \
      "Expected stable pack rows in DeltaTree Engine.")                                                                \
    ...
    M(SettingInt64,                                                                                                    \
      dt_bg_gc_max_segments_to_check_every_round,                                                                      \
      100,                                                                                                             \
      "Max segments to check in every gc round, value less than or equal to 0 means gc no segments.")                  \
    M(SettingFloat,                                                                                                    \
      dt_bg_gc_ratio_threhold_to_trigger_gc,                                                                           \
      1.2,                                                                                                             \
      "Trigger segment's gc when the ratio of invalid version exceed this threhold. Values smaller than or equal to "  \
      "1.0 means gc all "                                                                                              \
      "segments")                                                                                                      \
    M(SettingFloat,                                                                                                    \
      dt_bg_gc_delta_delete_ratio_to_trigger_gc,                                                                       \
      0.3,                                                                                                             \
      "Trigger segment's gc when the ratio of delta delete range to stable exceeds this ratio.")                       \
    M(SettingUInt64,                                                                                                   \
      dt_insert_max_rows,                                                                                              \
      0,                                                                                                               \
      "Max rows of insert blocks when write into DeltaTree Engine. By default 0 means no limit.")                      \
    M(SettingBool,                                                                                                     \
      dt_enable_rough_set_filter,                                                                                      \
      true,                                                                                                            \
      "Whether to parse where expression as Rough Set Index filter or not.")                                           \
    M(SettingBool,                                                                                                     \
      dt_raw_filter_range,                                                                                             \
      true,                                                                                                            \
      "[unused] Do range filter or not when read data in raw mode in DeltaTree Engine.")                               \
    ...
    M(SettingUInt64,                                                                                                   \
      dt_open_file_max_idle_seconds,                                                                                   \
      15,                                                                                                              \
      "Deprecated. Max idle time of opening files, 0 means infinite.")                                                 \
    M(SettingUInt64, dt_page_num_max_expect_legacy_files, 100, "Deprecated. Max number of legacy file expected")       \
    M(SettingFloat,                                                                                                    \
      dt_page_num_max_gc_valid_rate,                                                                                   \
      1.0,                                                                                                             \
      "Deprecated. Max valid rate of deciding a page file can be compact when existing legacy files are more over "    \
      "than "                                                                                                          \
      "`dt_storage_num_max_expect_legacy_files`")                                                                      \
    M(SettingFloat,                                                                                                    \
      dt_page_gc_low_write_prob,                                                                                       \
      0.10,                                                                                                            \
      "Deprecated. Probability to run gc when write there is few writes.")                                             \
                                                                                                                       \
    M(SettingUInt64,                                                                                                   \
      dt_storage_pool_log_write_slots,                                                                                 \
      4,                                                                                                               \
      "Deprecated. Max write concurrency for each StoragePool.log.")                                                   \
    M(SettingUInt64, dt_storage_pool_log_gc_min_file_num, 10, "Deprecated. Min number of page files to compact")       \
    M(SettingUInt64,                                                                                                   \
      dt_storage_pool_log_gc_min_legacy_num,                                                                           \
      3,                                                                                                               \
      "Deprecated. Min number of legacy page files to compact")                                                        \
    M(SettingUInt64,                                                                                                   \
      dt_storage_pool_log_gc_min_bytes,                                                                                \
      128 * Constant::MB,                                                                                              \
      "Deprecated. Min bytes of page data to compact")                                                                 \
    M(SettingFloat,                                                                                                    \
      dt_storage_pool_log_gc_max_valid_rate,                                                                           \
      0.35,                                                                                                            \
      "Deprecated. Max valid rate of deciding a page file can be compact")                                             \
                                                                                                                       \
    M(SettingUInt64,                                                                                                   \
      dt_storage_pool_data_write_slots,                                                                                \
      1,                                                                                                               \
      "Deprecated. Max write concurrency for each StoragePool.data.")                                                  \
    M(SettingUInt64, dt_storage_pool_data_gc_min_file_num, 10, "Deprecated. Min number of page files to compact")      \
    M(SettingUInt64,                                                                                                   \
      dt_storage_pool_data_gc_min_legacy_num,                                                                          \
      3,                                                                                                               \
      "Deprecated. Min number of legacy page files to compact")                                                        \
    M(SettingUInt64,                                                                                                   \
      dt_storage_pool_data_gc_min_bytes,                                                                               \
      128 * Constant::MB,                                                                                              \
      "Deprecated. Min bytes of page data to compact")                                                                 \
    M(SettingFloat,                                                                                                    \
      dt_storage_pool_data_gc_max_valid_rate,                                                                          \
      0.35,                                                                                                            \
      "Deprecated. Max valid rate of deciding a page file can be compact")                                             \
                                                                                                                       \
    M(SettingUInt64,                                                                                                   \
      dt_storage_pool_meta_write_slots,                                                                                \
      2,                                                                                                               \
      "Deprecated. Max write concurrency for each StoragePool.meta.")                                                  \
    M(SettingUInt64, dt_storage_pool_meta_gc_min_file_num, 10, "Deprecated. Min number of page files to compact")      \
    M(SettingUInt64,                                                                                                   \
      dt_storage_pool_meta_gc_min_legacy_num,                                                                          \
      3,                                                                                                               \
      "Deprecated. Min number of legacy page files to compact")                                                        \
    M(SettingUInt64,                                                                                                   \
      dt_storage_pool_meta_gc_min_bytes,                                                                               \
      128 * Constant::MB,                                                                                              \
      "Deprecated. Min bytes of page data to compact")                                                                 \
    M(SettingFloat,                                                                                                    \
      dt_storage_pool_meta_gc_max_valid_rate,                                                                          \
      0.35,                                                                                                            \
      "Deprecated. Max valid rate of deciding a page file can be compact")                                             \
                                                                                                                       \
    ...
    M(SettingDouble,                                                                                                   \
      dt_page_gc_threshold_raft_data,                                                                                  \
      0.05,                                                                                                            \
      "Max valid rate of deciding to do a GC for BlobFile storing PageData in PageStorage")                            \
    ...
    M(SettingDouble,                                                                                                   \
      dt_read_thread_count_scale,                                                                                      \
      1.0,                                                                                                             \
      "Number of read thread = number of logical cpu cores * dt_read_thread_count_scale.  Only has meaning at server " \
      "startup.")                                                                                                      \
    M(SettingDouble,                                                                                                   \
      dt_filecache_max_downloading_count_scale,                                                                        \
      1.0,                                                                                                             \
      "Max downloading task count of FileCache = io thread count * dt_filecache_max_downloading_count_scale.")         \
    M(SettingUInt64,                                                                                                   \
      dt_filecache_min_age_seconds,                                                                                    \
      1800,                                                                                                            \
      "Files of the same priority can only be evicted from files that were not accessed within "                       \
      "`dt_filecache_min_age_seconds` seconds.")                                                                       \
    M(SettingUInt64,                                                                                                   \
      dt_small_file_size_threshold,                                                                                    \
      128 * 1024,                                                                                                      \
      "for dmfile, when the file size less than dt_small_file_size_threshold, it will be merged. If "                  \
      "dt_small_file_size_threshold = 0, dmfile will just do as v2")                                                   \
    M(SettingUInt64,                                                                                                   \
      dt_merged_file_max_size,                                                                                         \
      16 * 1024 * 1024,                                                                                                \
      "Small files are merged into one or more files not larger than dt_merged_file_max_size")                         \
    M(SettingUInt64,                                                                                                   \
      dt_fetch_pages_packet_limit_size,                                                                                \
      0,                                                                                                               \
      "Response packet size limit of FetchDisaggPages, 0 means one page per packet")                                   \
    M(SettingUInt64,                                                                                                   \
      dt_write_page_cache_limit_size,                                                                                  \
      2 * 1024 * 1024,                                                                                                 \
      "Limit size per write batch when compute node writing to PageStorage cache")                                     \
    M(SettingDouble,                                                                                                   \
      io_thread_count_scale,                                                                                           \
      5.0,                                                                                                             \
      "Number of thread of IOThreadPool = number of logical cpu cores * io_thread_count_scale.  Only has meaning at "  \
      "server startup.")                                                                                               \
    M(SettingDouble,                                                                                                   \
      dt_fetch_page_concurrency_scale,                                                                                 \
      4.0,                                                                                                             \
      "Concurrency of fetching pages of one query equals to num_streams * dt_fetch_page_concurrency_scale.")           \
    M(SettingDouble,                                                                                                   \
      dt_prepare_stream_concurrency_scale,                                                                             \
      2.0,                                                                                                             \
      "Concurrency of preparing streams of one query equals to num_streams * dt_prepare_stream_concurrency_scale.")    \
    M(SettingUInt64,                                                                                                   \
      init_thread_count_scale,                                                                                         \
      100,                                                                                                             \
      "Number of thread = number of logical cpu cores * init_thread_count_scale. It just works for thread pool for "   \
      "initStores and loadMetadata")                                                                                   \
                                                                                                                       \
    M(SettingChecksumAlgorithm,                                                                                        \
      dt_checksum_algorithm,                                                                                           \
      ChecksumAlgo::XXH3,                                                                                              \
      "Checksum algorithm for delta tree stable storage")                                                              \
    M(SettingCompressionMethod,                                                                                        \
      dt_compression_method,                                                                                           \
      CompressionMethod::LZ4,                                                                                          \
      "The method of data compression when writing.")                                                                  \
    ...
    M(SettingInt64,                                                                                                    \
      ...
      30,                                                                                                              \
      "The interval of uploading checkpoint to the remote store. Unit is second.")                                     \
    M(SettingBool,                                                                                                     \
      remote_checkpoint_only_upload_manifest,                                                                          \
      true,                                                                                                            \
      "Only upload manifest data when uploading checkpoint")                                                           \
    M(SettingInt64,                                                                                                    \
      remote_gc_method,                                                                                                \
      1,                                                                                                               \
    ...
    M(SettingInt64,                                                                                                    \
      ...
      3600,                                                                                                            \
      "The interval of running GC task on the remote store. Unit is second.")                                          \
    M(SettingInt64, remote_gc_verify_consistency, 0, "Verify the consistenct of valid locks when doing GC")            \
    M(SettingInt64,                                                                                                    \
      remote_gc_min_age_seconds,                                                                                       \
      3600,                                                                                                            \
      "The file will NOT be compacted when the time difference between the last modification is less than this "       \
      "threshold")                                                                                                     \
    M(SettingDouble, remote_gc_ratio, 0.5, "The files with valid rate less than this threshold will be compacted")     \
    M(SettingInt64,                                                                                                    \
      remote_gc_small_size,                                                                                            \
      128 * 1024,                                                                                                      \
      "The files with total size less than this threshold will be compacted")                                          \
    M(SettingDouble,                                                                                                   \
      disagg_read_concurrency_scale,                                                                                   \
      20.0,                                                                                                            \
      "Scale * logical cpu cores = disaggregated read IO concurrency.")                                                \
                                                                                                                       \
    M(SettingInt64,                                                                                                    \
      fap_wait_checkpoint_timeout_seconds,                                                                             \
      60,                                                                                                              \
      "The max time wait for a usable checkpoint for FAP. Unit is second.")                                            \
                                                                                                                       \
    M(SettingUInt64,                                                                                                   \
      max_rows_in_set,                                                                                                 \
      0,                                                                                                               \
    ...
    M(SettingUInt64,                                                                                                   \
      rf_max_in_value_set,                                                                                             \
      1024,                                                                                                            \
      "Maximum size of the set (in number of elements) resulting from the execution of the RF IN Predicate.")          \
    M(SettingUInt64,                                                                                                   \
      max_bytes_in_set,                                                                                                \
      0,                                                                                                               \
    ...
    M(SettingUInt64,                                                                                                   \
      ...
      0,                                                                                                               \
      "Maximum size (in rows) of the transmitted external table obtained when the GLOBAL IN/JOIN section is "          \
      "executed.")                                                                                                     \
    M(SettingUInt64,                                                                                                   \
      max_bytes_to_transfer,                                                                                           \
      0,                                                                                                               \
      "Maximum size (in uncompressed bytes) of the transmitted external table obtained when the GLOBAL IN/JOIN "       \
      "section is executed.")                                                                                          \
    M(SettingOverflowMode<false>,                                                                                      \
    ...
    M(SettingOverflowMode<false>,                                                                                      \
      ...
      "What to do when the limit is exceeded.")                                                                        \
                                                                                                                       \
    M(SettingMemoryLimit,                                                                                              \
      max_memory_usage,                                                                                                \
      UInt64(0),                                                                                                       \
      "Maximum memory usage for processing of single query. Can either be an UInt64 (means memory limit in bytes), "   \
      "or be a float-point number (means memory limit in percent of total RAM, from 0.0 to 1.0). 0 or 0.0 means "      \
      "unlimited.")                                                                                                    \
    M(SettingMemoryLimit,                                                                                              \
      max_memory_usage_for_user,                                                                                       \
      UInt64(0),                                                                                                       \
      "Maximum memory usage for processing all concurrently running queries for the user. Can either be an UInt64 "    \
      "(means memory limit in bytes), "                                                                                \
      "or be a float-point number (means memory limit in percent of total RAM, from 0.0 to 1.0). 0 or 0.0 means "      \
      "unlimited.")                                                                                                    \
    M(SettingMemoryLimit,                                                                                              \
      max_memory_usage_for_all_queries,                                                                                \
      0.80,                                                                                                            \
      "Maximum memory usage for processing all concurrently running queries on the server. Can either be an UInt64 "   \
      "(means memory limit in bytes), "                                                                                \
      "or be a float-point number (means memory limit in percent of total RAM, from 0.0 to 1.0). 0 or 0.0 means "      \
      "unlimited.")                                                                                                    \
    M(SettingUInt64,                                                                                                   \
      bytes_that_rss_larger_than_limit,                                                                                \
      1073741824,                                                                                                      \
      "How many bytes RSS(Resident Set Size) can be larger than limit(max_memory_usage_for_all_queries). Default: "    \
      "1GB ")                                                                                                          \
                                                                                                                       \
    M(SettingUInt64,                                                                                                   \
    ...
    M(SettingUInt64,                                                                                                   \
      ...
      0,                                                                                                               \
      "The maximum speed of data exchange over the network in bytes per second for all concurrently running user "     \
      "queries. Zero means "                                                                                           \
      "unlimited.")                                                                                                    \
    M(SettingUInt64,                                                                                                   \
      max_network_bandwidth_for_all_users,                                                                             \
      0,                                                                                                               \
      "The maximum speed of data exchange over the network in bytes per second for all concurrently running queries. " \
      "Zero means "                                                                                                    \
      "unlimited.")                                                                                                    \
    ...
    M(SettingUInt64,                                                                                                   \
      ...
      0,                                                                                                               \
      "The soft limit of count of active query set for min_tso task scheduler.")                                       \
    M(SettingUInt64,                                                                                                   \
      max_grpc_pollers,                                                                                                \
      200,                                                                                                             \
      "The maximum number of grpc thread pool's non-temporary threads, better tune it up to avoid frequent "           \
      "creation/destruction of threads.")                                                                              \
    ...
    M(SettingUInt64,                                                                                                   \
      grpc_completion_queue_pool_size,                                                                                 \
      0,                                                                                                               \
      "The size of gRPC completion queue pool. 0 means using hardware_concurrency.")                                   \
    ...
    M(SettingUInt64,                                                                                                   \
      ...
      60000,                                                                                                           \
      "Continuously compact more segments until reaching specified elapsed time. If 0 is specified, only one segment " \
      "will be compacted each round.")                                                                                 \
    M(SettingUInt64,                                                                                                   \
      max_bytes_before_external_join,                                                                                  \
      0,                                                                                                               \
      "max bytes used by join before spill, 0 as the default value, 0 means no limit")                                 \
    M(SettingInt64,                                                                                                    \
      join_restore_concurrency,                                                                                        \
      0,                                                                                                               \
      "join restore concurrency, negative value means restore join serially, 0 means TiFlash choose restore "          \
      "concurrency automatically, 0 as the default value")                                                             \
    M(SettingUInt64,                                                                                                   \
      max_cached_data_bytes_in_spiller,                                                                                \
      1024ULL * 1024 * 100,                                                                                            \
      "Max cached data bytes in spiller before spilling, 100MB as the default value, 0 means no limit")                \
    M(SettingUInt64,                                                                                                   \
      max_spilled_rows_per_file,                                                                                       \
      200000,                                                                                                          \
      "Max spilled data rows per spill file, 200000 as the default value, 0 means no limit.")                          \
    M(SettingUInt64,                                                                                                   \
      max_spilled_bytes_per_file,                                                                                      \
      0,                                                                                                               \
      "Max spilled data bytes per spill file, 0 as the default value, 0 means no limit.")                              \
    ...
    M(SettingUInt64,                                                                                                   \
      pipeline_cpu_task_thread_pool_size,                                                                              \
      0,                                                                                                               \
      "The size of cpu task thread pool. 0 means using number_of_logical_cpu_cores.")                                  \
    M(SettingUInt64,                                                                                                   \
      pipeline_io_task_thread_pool_size,                                                                               \
      0,                                                                                                               \
      "The size of io task thread pool. 0 means using number_of_logical_cpu_cores.")                                   \
    M(SettingTaskQueueType,                                                                                            \
      pipeline_cpu_task_thread_pool_queue_type,                                                                        \
      TaskQueueType::DEFAULT,                                                                                          \
      "The task queue of cpu task thread pool")                                                                        \
    M(SettingTaskQueueType,                                                                                            \
      pipeline_io_task_thread_pool_queue_type,                                                                         \
      TaskQueueType::DEFAULT,                                                                                          \
      "The task queue of io task thread pool")                                                                         \
    ...
    M(SettingUInt64,                                                                                                   \
      recv_queue_size,                                                                                                 \
      0,                                                                                                               \
      "size of ExchangeReceiver queue, 0 means the size is set to data_source_mpp_task_num * 50")                      \
    M(SettingUInt64,                                                                                                   \
      shallow_copy_cross_probe_threshold,                                                                              \
      0,                                                                                                               \
      "minimum right rows to use shallow copy probe mode for cross join, default is max(1, max_block_size/10)")        \
    M(SettingInt64,                                                                                                    \
      max_buffered_bytes_in_executor,                                                                                  \
      200LL * 1024 * 1024,                                                                                             \
      "The max buffered size in each executor, 0 mean unlimited, use 200MB as the default value")                      \
