...
{
public:
    JoinPartition(JoinType join_type_, ASTTableJoin::Kind kind_, ASTTableJoin::Strictness strictness_, size_t max_block_size, const LoggerPtr & log_, bool has_other_condition_)
        : kind(kind_)
