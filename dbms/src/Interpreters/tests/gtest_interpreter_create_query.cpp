...
public:
    ...
    void SetUp() override
    {
        ...
        {
            // create db
            String statement = R"json(CREATE DATABASE IF NOT EXISTS `db_2` ENGINE = TiFlash('{"charset":"utf8mb4","collate":"utf8mb4_bin","db_name":{"L":"test","O":"test"},"id":2,"keyspace_id":4294967295,"state":5}', 1))json";
