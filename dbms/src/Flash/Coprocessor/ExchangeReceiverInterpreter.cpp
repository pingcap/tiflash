...
void ExchangeReceiverInterpreter::executeWhere(
...
void ExchangeReceiverInterpreter::executeAggregation(
    DAGPipeline & pipeline,
...
void ExchangeReceiverInterpreter::executeExpression(DAGPipeline & pipeline, const ExpressionActionsPtr & expressionActionsPtr)
{
...
void ExchangeReceiverInterpreter::executeOrder(DAGPipeline & pipeline, const std::vector<NameAndTypePair> & order_columns)
{
...
void ExchangeReceiverInterpreter::executeProject(DAGPipeline & pipeline, NamesWithAliases & project_cols)
{
...
void ExchangeReceiverInterpreter::executeLimit(DAGPipeline & pipeline)
{
    size_t limit = 0;
...
DAGPipelinePtr ExchangeReceiverInterpreter::execute()
{
