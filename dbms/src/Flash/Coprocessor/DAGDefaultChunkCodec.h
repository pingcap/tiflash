...
class DAGDefaultChunkCodec : public DAGChunkCodec
{
public:
    explicit DAGDefaultChunkCodec(const std::vector<tipb::FieldType> & result_field_types) : DAGChunkCodec(result_field_types) {}
