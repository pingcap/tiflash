...
template <>
DAGDriver<DAGDriverKind::Cop>::DAGDriver(
    Context & context_,
    UInt64 start_ts,
    UInt64 schema_ver,
...
template <>
DAGDriver<DAGDriverKind::CopStream>::DAGDriver(
    Context & context_,
    UInt64 start_ts,
    UInt64 schema_ver,
...
template <>
DAGDriver<DAGDriverKind::BatchCop>::DAGDriver(
    Context & context_,
    UInt64 start_ts,
    UInt64 schema_ver,
...
try
{
    ...
    if constexpr (Kind == DAGDriverKind::Cop)
    {
    ...
    else if (Kind == DAGDriverKind::CopStream)
    {
    ...
    else if (Kind == DAGDriverKind::BatchCop)
    {
    ...
    else if constexpr (Kind == DAGDriverKind::CopStream)
    {
    ...
    else if constexpr (Kind == DAGDriverKind::BatchCop)
    {
...
template class DAGDriver<DAGDriverKind::Cop>;
template class DAGDriver<DAGDriverKind::CopStream>;
template class DAGDriver<DAGDriverKind::BatchCop>;
