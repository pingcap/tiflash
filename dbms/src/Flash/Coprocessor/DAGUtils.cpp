...
std::unordered_map<tipb::ScalarFuncSig, String> scalar_func_map({
    ...
    {tipb::ScalarFuncSig::CastDecimalAsInt, "tidb_cast"}, {tipb::ScalarFuncSig::CastDecimalAsReal, "tidb_cast"},
    ...
    {tipb::ScalarFuncSig::ModReal, "modulo"}, {tipb::ScalarFuncSig::ModDecimal, "modulo"},
    {tipb::ScalarFuncSig::ModIntUnsignedUnsigned, "modulo"}, {tipb::ScalarFuncSig::ModIntUnsignedSigned, "modulo"},
    {tipb::ScalarFuncSig::ModIntSignedUnsigned, "modulo"}, {tipb::ScalarFuncSig::ModIntSignedSigned, "modulo"},
    ...
    {tipb::ScalarFuncSig::CeilIntToDec, "ceil"}, {tipb::ScalarFuncSig::CeilIntToInt, "ceil"},
    {tipb::ScalarFuncSig::CeilDecToInt, "ceilDecimalToInt"}, {tipb::ScalarFuncSig::CeilDecToDec, "ceil"},
    {tipb::ScalarFuncSig::CeilReal, "ceil"},

    {tipb::ScalarFuncSig::FloorIntToDec, "floor"}, {tipb::ScalarFuncSig::FloorIntToInt, "floor"},
    {tipb::ScalarFuncSig::FloorDecToInt, "floorDecimalToInt"}, {tipb::ScalarFuncSig::FloorDecToDec, "floor"},
    {tipb::ScalarFuncSig::FloorReal, "floor"},

    {tipb::ScalarFuncSig::RoundReal, "tidbRound"}, {tipb::ScalarFuncSig::RoundInt, "tidbRound"},
    ...
    {tipb::ScalarFuncSig::Log1Arg, "log"}, {tipb::ScalarFuncSig::Log2Args, "log2args"}, {tipb::ScalarFuncSig::Log2, "log2"},
    {tipb::ScalarFuncSig::Log10, "log10"},

    {tipb::ScalarFuncSig::Rand, "rand"},
    //{tipb::ScalarFuncSig::RandWithSeedFirstGen, "cast"},

    {tipb::ScalarFuncSig::Pow, "pow"}, {tipb::ScalarFuncSig::Conv, "conv"}, {tipb::ScalarFuncSig::CRC32, "crc32"},
    ...
    {tipb::ScalarFuncSig::Degrees, "degrees"}, {tipb::ScalarFuncSig::Exp, "exp"},
    //{tipb::ScalarFuncSig::PI, "cast"},
    {tipb::ScalarFuncSig::Radians, "radians"}, {tipb::ScalarFuncSig::Sin, "sin"}, {tipb::ScalarFuncSig::Tan, "tan"},
    {tipb::ScalarFuncSig::TruncateInt, "trunc"}, {tipb::ScalarFuncSig::TruncateReal, "trunc"},
    ...
    {tipb::ScalarFuncSig::InetAton, "tiDBIPv4StringToNum"}, {tipb::ScalarFuncSig::InetNtoa, "IPv4NumToString"},
    {tipb::ScalarFuncSig::Inet6Aton, "tiDBIPv6StringToNum"}, {tipb::ScalarFuncSig::Inet6Ntoa, "tiDBIPv6NumToString"},
    ...
    {tipb::ScalarFuncSig::StrToDateDate, "strToDateDate"}, {tipb::ScalarFuncSig::StrToDateDatetime, "strToDateDatetime"},
    ...
    {tipb::ScalarFuncSig::Length, "length"}, {tipb::ScalarFuncSig::Locate2ArgsUTF8, "position"},
