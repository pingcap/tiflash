...
{
public:
    InterpreterDAG(Context & context_, const DAGQuerySource & dag_, const LogWithPrefixPtr & log_);
...
private:
    DAGPipelinePtr executeQueryBlock(DAGQueryBlock & query_block, std::vector<SubqueriesForSets> & subqueries_for_sets);
