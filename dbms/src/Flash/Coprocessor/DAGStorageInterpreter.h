...
public:
    ...
    std::vector<ExtraCastAfterTS> is_need_add_cast_column;
...
private:
    ...
    std::tuple<Names, NamesAndTypes, std::vector<ExtraCastAfterTS>, String> getColumnsForTableScan(Int64 max_columns_to_read);
