...
PipelineExecPtr PipelineExecBuilder::build(bool internal_break_time, uint64_t minTSO_wait_time_in_ms)
{
...
PipelineExecGroup PipelineExecGroupBuilder::build(bool internal_break_time, uint64_t minTSO_wait_time_in_ms)
{
    ...
    for (auto & group : groups)
    {
        ...
        for (auto & builder : group)
            pipeline_exec_group.push_back(builder.build(internal_break_time, minTSO_wait_time_in_ms));
    }
