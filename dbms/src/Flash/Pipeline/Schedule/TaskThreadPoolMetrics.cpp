...
#define INC_METRIC(metric_name, value)                                                   \
    if constexpr (is_cpu)                                                                 \
    {                                                                                     \
        GET_METRIC(tiflash_pipeline_scheduler, type_cpu_##metrics_name).Increment(value); \
    }                                                                                     \
    else                                                                                  \
    {                                                                                     \
        GET_METRIC(tiflash_pipeline_scheduler, type_io_##metrics_name).Increment(value);  \
    }

#define DEC_METRIC(metric_name, value)                                                   \
    if constexpr (is_cpu)                                                                 \
    {                                                                                     \
        GET_METRIC(tiflash_pipeline_scheduler, type_cpu_##metrics_name).Decrement(value); \
    }                                                                                     \
    else                                                                                  \
    {                                                                                     \
        GET_METRIC(tiflash_pipeline_scheduler, type_io_##metrics_name).Decrement(value);  \
    }

#define SET_METRIC(metric_name, value)                                             \
    if constexpr (is_cpu)                                                           \
    {                                                                               \
        GET_METRIC(tiflash_pipeline_scheduler, type_cpu_##metrics_name).Set(value); \
    }                                                                               \
    else                                                                            \
    {                                                                               \
        GET_METRIC(tiflash_pipeline_scheduler, type_io_##metrics_name).Set(value);  \
    }
