...
PhysicalTiCIScan::PhysicalTiCIScan(
...
PhysicalPlanNodePtr PhysicalTiCIScan::build(
    const String & executor_id,
    const LoggerPtr & log,
    const TiCIScan & tici_scan)
{
    auto schema = genNamesAndTypesForTiCI(tici_scan.getReturnColumns(), "column");
...
void PhysicalTiCIScan::buildPipeline(
...
const Block & PhysicalTiCIScan::getSampleBlock() const
{
    return sample_block;
}

void PhysicalTiCIScan::buildPipelineExecGroupImpl(
