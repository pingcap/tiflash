...
grpc::Status CoprocessorHandler::execute()
{
    ...
    try
    {
        ...
        case COP_REQ_TYPE_DAG:
        {
            ...
            LOG_FMT_DEBUG(log, "{}: Handling DAG request: {}", __PRETTY_FUNCTION__, dag_request.DebugString());
            ...
            table_regions_info.local_regions.emplace(cop_context.kv_context.region_id(),
    ...
    {
        LOG_FMT_WARNING(log, "{}: LockException: region {}, message: {}", __PRETTY_FUNCTION__, cop_request->context().region_id(), e.message());
        cop_response->Clear();
    ...
    {
        LOG_FMT_WARNING(log, "{}: RegionException: region {}, message: {}", __PRETTY_FUNCTION__, cop_request->context().region_id(), e.message());
        cop_response->Clear();
