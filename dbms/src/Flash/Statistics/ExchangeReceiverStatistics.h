...
struct ExchangeReceiverStatistics
{
    ...
    ExchangeReceiverStatistics(const String & executor_id_): executor_id(executor_id_)
    {}
    ...
    static void buildStatistics(ExchangeReceiverStatistics & statistics, const ProfileStreamsInfo & profile_streams_info, DAGContext & dag_context)
    {
    }
};