    ...
    mpp::DispatchTaskResponse * response)
{
    ...
    GET_RESOURCE_GROUP_METRIC(tiflash_resource_group, type_dispatch_mpp_task, resource_group).Increment();
    ...
    SCOPE_EXIT({
        ...
        GET_RESOURCE_GROUP_METRIC(tiflash_resource_group, type_dispatch_mpp_task, resource_group).Decrement();
    ...
    grpc::ServerWriter<mpp::MPPDataPacket> * sync_writer)
{
    ...
    GET_METRIC(tiflash_coprocessor_request_count, type_mpp_establish_conn).Increment();
    GET_METRIC(tiflash_coprocessor_handling_request_count, type_mpp_establish_conn).Increment();
    GET_RESOURCE_GROUP_METRIC(tiflash_resource_group, type_mpp_establish_conn, resource_group).Increment();
    ...
    SCOPE_EXIT({
        ...
        GET_RESOURCE_GROUP_METRIC(tiflash_resource_group, type_mpp_establish_conn, resource_group).Decrement();
    ...
    mpp::CancelTaskResponse * response)
{
    ...
    GET_RESOURCE_GROUP_METRIC(tiflash_resource_group, type_cancel_mpp_task, resource_group).Increment();
    Stopwatch watch;
    SCOPE_EXIT({
        GET_METRIC(tiflash_coprocessor_handling_request_count, type_cancel_mpp_task).Decrement();
        GET_RESOURCE_GROUP_METRIC(tiflash_resource_group, type_cancel_mpp_task, resource_group).Decrement();
