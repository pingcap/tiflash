...
HashedDictionary::Attribute HashedDictionary::createAttributeWithType(
...
template <typename T>
void HashedDictionary::has(const Attribute & attribute, const PaddedPODArray<Key> & ids, PaddedPODArray<UInt8> & out)
    const
{
