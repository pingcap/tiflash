...
const std::string & TiDBService::serviceIp() const { return service_ip; }

const std::string & TiDBService::statusPort() const { return status_port; }

const std::unordered_set<std::string> & TiDBService::ignoreDatabases() const { return ignore_databases; }
