...
public:
    ...
    {
        if (
            (salt_count_ == f.salt_count_) && (table_size_ == f.table_size_) && (random_seed_ == f.random_seed_) && (projected_element_count_ == f.projected_element_count_) && (inserted_element_count_ == f.inserted_element_count_) && (desired_false_positive_probability_ == f.desired_false_positive_probability_) && (bit_table_.size() == f.bit_table_.size()) && (salt_.size() == f.salt_.size()))
        {
            for (std::size_t i = 0; i < bit_table_.size(); ++i)
            {
