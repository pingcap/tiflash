...
void SSTFilesToDTFilesOutputStream::write()
{
    ...
    while (true)
    {
        ...
        std::tie(cur_effective_num_rows, cur_not_clean_rows, cur_is_deleted_rows, property.gc_hint_version) //
        ...
        property.is_deleted_rows = cur_is_deleted_rows - last_is_deleted_rows;
        ...
        last_is_deleted_rows = cur_is_deleted_rows;
    }
}
