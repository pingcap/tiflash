...
{
public:
    ColumnSharingCacheMap() : stats(static_cast<int>(ColumnCacheStatus::_TOTAL_COUNT)) {}
    ...
    std::string statString() const
    {
        ...
        return fmt::format("add_count {} add_stale {} add_ratio {} get_miss {} get_part {} get_hit {} get_copy {} cached_ratio {}", 
            add_count, add_stale, add_count * 1.0 / add_total, get_miss, get_part, get_hit, get_copy, get_cached * 1.0 / get_total);
    }
private:
