...
public:
    ...
    ~DMVersionFilterBlockInputStream()
    {
        LOG_FMT_DEBUG(log,
                  ...
                  total_rows, (Float64)passed_rows * 100 / total_rows, (Float64)complete_passed * 100 / total_blocks,
                  (Float64)complete_not_passed * 100 / total_blocks, (Float64)not_clean_rows * 100 / passed_rows,
                  (Float64)effective_num_rows * 100 / passed_rows, version_limit, (query_id.empty() ? "<non-query>" : query_id));
    }
