...
public:
    ...
    bool writeToDisk(DMContext & dm_context, const ColumnFilePtr & pack);
    ...
    bool ingestPacks(DMContext & dm_context, const RowKeyRange & range, const ColumnFiles & packs, bool clear_data_in_range);
