                                                               ...
                                                               WriteBatches & wbs) const
{
    ...
    for (auto & dmfile : segment_snap->stable->getDMFiles())
    {
        ...
        auto my_dmfile = DMFile::restore(dm_context.db_context.getFileProvider(), file_id, /* ref_id= */ my_dmfile_id, file_parent_path, DMFile::ReadMetaMode::all());
        auto other_dmfile
            = DMFile::restore(dm_context.db_context.getFileProvider(), file_id, /* ref_id= */ other_dmfile_id, file_parent_path, DMFile::ReadMetaMode::all());
