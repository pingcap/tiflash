...
{
    auto   dmfile        = DMFile::create(dm_context.db_context.getFileProvider(), file_id, parent_path, dm_context.db_context.getSettingsRef().dt_enable_single_file_mode_dmfile);
