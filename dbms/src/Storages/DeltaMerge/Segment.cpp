                                    ...
                                    bool need_rate_limit)
{
    ...
    LOG_DEBUG(&Poco::Logger::get("createNewStable"), store_path << " DTFile " << dtfile_id << " create " << dtfile->getBytesOnDisk() << " bytes");
                                                               ...
                                                               WriteBatches & wbs) const
{
    ...
    for (auto & dmfile : segment_snap->stable->getDMFiles())
    {
        ...
        auto other_dmfile = DMFile::restore(dm_context.db_context.getFileProvider(),
                                            file_id,
