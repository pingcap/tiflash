...
SegmentPtr Segment::newSegment(DMContext &              context,
                               ...
                               PageId                   stable_id)
{
    WriteBatches wbs(context.storage_pool, context.db_context.getIORateLimiter().getWriteLimiter());
...
bool Segment::write(DMContext & dm_context, const Block & block)
{
    ...
    WriteBatches wbs(dm_context.storage_pool, dm_context.db_context.getIORateLimiter().getWriteLimiter());
