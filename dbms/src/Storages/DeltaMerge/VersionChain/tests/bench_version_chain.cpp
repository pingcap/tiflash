        ...
        auto bench_impl = [&](auto handle_type) {
            {
                ...
                buildVersionChain(*dm_context, *segment_snapshot, version_chain, NotReleaseCache); // Warming up
...
try
{
    ...
    else if (type == BenchType::VersionChain)
    {
        auto bench_impl = [&](auto handle_type) {
            ...
            buildVersionChain(*dm_context, *segment_snapshot, base_version_chain, NotReleaseCache);
