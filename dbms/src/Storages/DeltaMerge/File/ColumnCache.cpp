...
namespace DB {
    namespace DM {
        ...
        std::pair<PackRange, ColumnPtr>
        ColumnCache::tryGetHandleColumn(size_t pack_id, size_t pack_count) {
        ...
        std::vector<PackRange> ColumnCache::splitPackRange(const PackRange &range, size_t start, size_t end) {
