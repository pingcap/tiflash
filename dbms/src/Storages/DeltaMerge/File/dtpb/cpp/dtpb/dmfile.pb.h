...
PROTOBUF_NAMESPACE_OPEN
template <>
::dtpb::PackProperties * Arena::CreateMaybeMessage<::dtpb::PackProperties>(Arena *);
template <>
::dtpb::PackProperty * Arena::CreateMaybeMessage<::dtpb::PackProperty>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace dtpb
{
// ===================================================================
...
public:
    ...
    inline const ::PROTOBUF_NAMESPACE_ID::UnknownFieldSet & unknown_fields() const { return _internal_metadata_.unknown_fields(); }
    inline ::PROTOBUF_NAMESPACE_ID::UnknownFieldSet * mutable_unknown_fields() { return _internal_metadata_.mutable_unknown_fields(); }
...
class PackProperties : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:dtpb.PackProperties) */
{
public:
    PackProperties();
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::dtpb::PackProperty> * PackProperties::mutable_property()
{
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::dtpb::PackProperty> & PackProperties::property() const
{
