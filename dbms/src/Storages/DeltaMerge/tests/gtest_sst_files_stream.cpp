...
public:
    ...
    {
        RUNTIME_CHECK(block_size > 0, Exception, "Check block_size > 0 failed");
        RUNTIME_CHECK(block_size < std::numeric_limits<Int64>::max(), Exception, "Check block_size < std::numeric_limits<Int64>::max() failed");
