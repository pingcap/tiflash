...
public:
    ...
    // TODO: remove this method, it can no longer represents the min, max of this chunk.
    // A chunk may be generated by serveral chunks, by simply append together, without sorting.
