...
StableValueSpacePtr StableValueSpace::restore(DMContext & context, PageId id)
{
    ...
    Page page = context.storage_pool.meta()->read(context.table_id, id, nullptr); // not limit restore
    ...
    for (size_t i = 0; i < size; ++i)
    {
        ...
        auto file_id = context.storage_pool.data()->getNormalPageId(context.table_id, ref_id);
