...
bool DeltaValueSpace::compact(DMContext & context)
{
    ...
    Stopwatch watch_prepare;
    {
        ...
        LOG_DEBUG(log, "Compact prepare done, cost={:.3f}s, info={}", seconds_prepare, simpleInfo());
    ...
    LOG_DEBUG(log, "Compact release snapshot done, cost={:.3f}s, info={}", seconds_release, simpleInfo());
