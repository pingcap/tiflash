...
#define PLANE_ID(MSB)                                                                                                                    \
    CONCAT(MSB, 0x00), CONCAT(MSB, 0x01), CONCAT(MSB, 0x02), CONCAT(MSB, 0x03), CONCAT(MSB, 0x04), CONCAT(MSB, 0x05), CONCAT(MSB, 0x06), \
        CONCAT(MSB, 0x07), CONCAT(MSB, 0x08), CONCAT(MSB, 0x09), CONCAT(MSB, 0x0A), CONCAT(MSB, 0x0B), CONCAT(MSB, 0x0C),                \
        CONCAT(MSB, 0x0D), CONCAT(MSB, 0x0E), CONCAT(MSB, 0x0F), CONCAT(MSB, 0x10), CONCAT(MSB, 0x11), CONCAT(MSB, 0x12),                \
        CONCAT(MSB, 0x13), CONCAT(MSB, 0x14), CONCAT(MSB, 0x15), CONCAT(MSB, 0x16), CONCAT(MSB, 0x17), CONCAT(MSB, 0x18),                \
        CONCAT(MSB, 0x19), CONCAT(MSB, 0x1A), CONCAT(MSB, 0x1B), CONCAT(MSB, 0x1C), CONCAT(MSB, 0x1D), CONCAT(MSB, 0x1E),                \
        CONCAT(MSB, 0x1F), CONCAT(MSB, 0x20), CONCAT(MSB, 0x21), CONCAT(MSB, 0x22), CONCAT(MSB, 0x23), CONCAT(MSB, 0x24),                \
        CONCAT(MSB, 0x25), CONCAT(MSB, 0x26), CONCAT(MSB, 0x27), CONCAT(MSB, 0x28), CONCAT(MSB, 0x29), CONCAT(MSB, 0x2A),                \
        CONCAT(MSB, 0x2B), CONCAT(MSB, 0x2C), CONCAT(MSB, 0x2D), CONCAT(MSB, 0x2E), CONCAT(MSB, 0x2F), CONCAT(MSB, 0x30),                \
        CONCAT(MSB, 0x31), CONCAT(MSB, 0x32), CONCAT(MSB, 0x33), CONCAT(MSB, 0x34), CONCAT(MSB, 0x35), CONCAT(MSB, 0x36),                \
        CONCAT(MSB, 0x37), CONCAT(MSB, 0x38), CONCAT(MSB, 0x39), CONCAT(MSB, 0x3A), CONCAT(MSB, 0x3B), CONCAT(MSB, 0x3C),                \
        CONCAT(MSB, 0x3D), CONCAT(MSB, 0x3E), CONCAT(MSB, 0x3F), CONCAT(MSB, 0x40), CONCAT(MSB, 0x41), CONCAT(MSB, 0x42),                \
        CONCAT(MSB, 0x43), CONCAT(MSB, 0x44), CONCAT(MSB, 0x45), CONCAT(MSB, 0x46), CONCAT(MSB, 0x47), CONCAT(MSB, 0x48),                \
        CONCAT(MSB, 0x49), CONCAT(MSB, 0x4A), CONCAT(MSB, 0x4B), CONCAT(MSB, 0x4C), CONCAT(MSB, 0x4D), CONCAT(MSB, 0x4E),                \
        CONCAT(MSB, 0x4F), CONCAT(MSB, 0x50), CONCAT(MSB, 0x51), CONCAT(MSB, 0x52), CONCAT(MSB, 0x53), CONCAT(MSB, 0x54),                \
        CONCAT(MSB, 0x55), CONCAT(MSB, 0x56), CONCAT(MSB, 0x57), CONCAT(MSB, 0x58), CONCAT(MSB, 0x59), CONCAT(MSB, 0x5A),                \
        CONCAT(MSB, 0x5B), CONCAT(MSB, 0x5C), CONCAT(MSB, 0x5D), CONCAT(MSB, 0x5E), CONCAT(MSB, 0x5F), CONCAT(MSB, 0x60),                \
        CONCAT(MSB, 0x61), CONCAT(MSB, 0x62), CONCAT(MSB, 0x63), CONCAT(MSB, 0x64), CONCAT(MSB, 0x65), CONCAT(MSB, 0x66),                \
        CONCAT(MSB, 0x67), CONCAT(MSB, 0x68), CONCAT(MSB, 0x69), CONCAT(MSB, 0x6A), CONCAT(MSB, 0x6B), CONCAT(MSB, 0x6C),                \
        CONCAT(MSB, 0x6D), CONCAT(MSB, 0x6E), CONCAT(MSB, 0x6F), CONCAT(MSB, 0x70), CONCAT(MSB, 0x71), CONCAT(MSB, 0x72),                \
        CONCAT(MSB, 0x73), CONCAT(MSB, 0x74), CONCAT(MSB, 0x75), CONCAT(MSB, 0x76), CONCAT(MSB, 0x77), CONCAT(MSB, 0x78),                \
        CONCAT(MSB, 0x79), CONCAT(MSB, 0x7A), CONCAT(MSB, 0x7B), CONCAT(MSB, 0x7C), CONCAT(MSB, 0x7D), CONCAT(MSB, 0x7E),                \
        CONCAT(MSB, 0x7F), CONCAT(MSB, 0x80), CONCAT(MSB, 0x81), CONCAT(MSB, 0x82), CONCAT(MSB, 0x83), CONCAT(MSB, 0x84),                \
        CONCAT(MSB, 0x85), CONCAT(MSB, 0x86), CONCAT(MSB, 0x87), CONCAT(MSB, 0x88), CONCAT(MSB, 0x89), CONCAT(MSB, 0x8A),                \
        CONCAT(MSB, 0x8B), CONCAT(MSB, 0x8C), CONCAT(MSB, 0x8D), CONCAT(MSB, 0x8E), CONCAT(MSB, 0x8F), CONCAT(MSB, 0x90),                \
        CONCAT(MSB, 0x91), CONCAT(MSB, 0x92), CONCAT(MSB, 0x93), CONCAT(MSB, 0x94), CONCAT(MSB, 0x95), CONCAT(MSB, 0x96),                \
        CONCAT(MSB, 0x97), CONCAT(MSB, 0x98), CONCAT(MSB, 0x99), CONCAT(MSB, 0x9A), CONCAT(MSB, 0x9B), CONCAT(MSB, 0x9C),                \
        CONCAT(MSB, 0x9D), CONCAT(MSB, 0x9E), CONCAT(MSB, 0x9F), CONCAT(MSB, 0xA0), CONCAT(MSB, 0xA1), CONCAT(MSB, 0xA2),                \
        CONCAT(MSB, 0xA3), CONCAT(MSB, 0xA4), CONCAT(MSB, 0xA5), CONCAT(MSB, 0xA6), CONCAT(MSB, 0xA7), CONCAT(MSB, 0xA8),                \
        CONCAT(MSB, 0xA9), CONCAT(MSB, 0xAA), CONCAT(MSB, 0xAB), CONCAT(MSB, 0xAC), CONCAT(MSB, 0xAD), CONCAT(MSB, 0xAE),                \
        CONCAT(MSB, 0xAF), CONCAT(MSB, 0xB0), CONCAT(MSB, 0xB1), CONCAT(MSB, 0xB2), CONCAT(MSB, 0xB3), CONCAT(MSB, 0xB4),                \
        CONCAT(MSB, 0xB5), CONCAT(MSB, 0xB6), CONCAT(MSB, 0xB7), CONCAT(MSB, 0xB8), CONCAT(MSB, 0xB9), CONCAT(MSB, 0xBA),                \
        CONCAT(MSB, 0xBB), CONCAT(MSB, 0xBC), CONCAT(MSB, 0xBD), CONCAT(MSB, 0xBE), CONCAT(MSB, 0xBF), CONCAT(MSB, 0xC0),                \
        CONCAT(MSB, 0xC1), CONCAT(MSB, 0xC2), CONCAT(MSB, 0xC3), CONCAT(MSB, 0xC4), CONCAT(MSB, 0xC5), CONCAT(MSB, 0xC6),                \
        CONCAT(MSB, 0xC7), CONCAT(MSB, 0xC8), CONCAT(MSB, 0xC9), CONCAT(MSB, 0xCA), CONCAT(MSB, 0xCB), CONCAT(MSB, 0xCC),                \
        CONCAT(MSB, 0xCD), CONCAT(MSB, 0xCE), CONCAT(MSB, 0xCF), CONCAT(MSB, 0xD0), CONCAT(MSB, 0xD1), CONCAT(MSB, 0xD2),                \
        CONCAT(MSB, 0xD3), CONCAT(MSB, 0xD4), CONCAT(MSB, 0xD5), CONCAT(MSB, 0xD6), CONCAT(MSB, 0xD7), CONCAT(MSB, 0xD8),                \
        CONCAT(MSB, 0xD9), CONCAT(MSB, 0xDA), CONCAT(MSB, 0xDB), CONCAT(MSB, 0xDC), CONCAT(MSB, 0xDD), CONCAT(MSB, 0xDE),                \
        CONCAT(MSB, 0xDF), CONCAT(MSB, 0xE0), CONCAT(MSB, 0xE1), CONCAT(MSB, 0xE2), CONCAT(MSB, 0xE3), CONCAT(MSB, 0xE4),                \
        CONCAT(MSB, 0xE5), CONCAT(MSB, 0xE6), CONCAT(MSB, 0xE7), CONCAT(MSB, 0xE8), CONCAT(MSB, 0xE9), CONCAT(MSB, 0xEA),                \
        CONCAT(MSB, 0xEB), CONCAT(MSB, 0xEC), CONCAT(MSB, 0xED), CONCAT(MSB, 0xEE), CONCAT(MSB, 0xEF), CONCAT(MSB, 0xF0),                \
        CONCAT(MSB, 0xF1), CONCAT(MSB, 0xF2), CONCAT(MSB, 0xF3), CONCAT(MSB, 0xF4), CONCAT(MSB, 0xF5), CONCAT(MSB, 0xF6),                \
        CONCAT(MSB, 0xF7), CONCAT(MSB, 0xF8), CONCAT(MSB, 0xF9), CONCAT(MSB, 0xFA), CONCAT(MSB, 0xFB), CONCAT(MSB, 0xFC),                \
        CONCAT(MSB, 0xFD), CONCAT(MSB, 0xFE), CONCAT(MSB, 0xFF)
