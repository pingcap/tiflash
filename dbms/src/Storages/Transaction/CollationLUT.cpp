...
#define PLANE_ID(MSB)                                                                                                                    \
    CONCAT(MSB, 0x00), CONCAT(MSB, 0x01), CONCAT(MSB, 0x02), CONCAT(MSB, 0x03), CONCAT(MSB, 0x04), CONCAT(MSB, 0x05), CONCAT(MSB, 0x06), \
        ...
        CONCAT(MSB, 0x3D), CONCAT(MSB, 0x3E), CONCAT(MSB, 0x3F), CONCAT(MSB, 0x40), CONCAT(MSB, 0x21), CONCAT(MSB, 0x22),                \
        CONCAT(MSB, 0x23), CONCAT(MSB, 0x24), CONCAT(MSB, 0x25), CONCAT(MSB, 0x26), CONCAT(MSB, 0x27), CONCAT(MSB, 0x28),                \
        CONCAT(MSB, 0x29), CONCAT(MSB, 0x2A), CONCAT(MSB, 0x2B), CONCAT(MSB, 0x2C), CONCAT(MSB, 0x2D), CONCAT(MSB, 0x2E),                \
        CONCAT(MSB, 0x2F), CONCAT(MSB, 0x30), CONCAT(MSB, 0x31), CONCAT(MSB, 0x32), CONCAT(MSB, 0x33), CONCAT(MSB, 0x34),                \
        CONCAT(MSB, 0x35), CONCAT(MSB, 0x36), CONCAT(MSB, 0x37), CONCAT(MSB, 0x38), CONCAT(MSB, 0x39), CONCAT(MSB, 0x3A),                \
