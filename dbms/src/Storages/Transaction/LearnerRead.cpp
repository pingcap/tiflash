            ...
            if (status != RegionException::RegionReadStatus::OK)
            {
                ...
                LOG_WARNING(log,
                    "Check memory cache, region "
                        ...
                        << RecordKVFormat::DecodedTiKVKeyToDebugString<false>(*region_to_query.range_in_table.second) << ") , status "
        ...
        if (status != RegionException::RegionReadStatus::OK)
        {
            ...
            LOG_WARNING(log,
                "Check after read from Storage, region "
                    ...
                    << ", handle range [" << RecordKVFormat::DecodedTiKVKeyToDebugString<true>(*region_query_info.range_in_table.first)
