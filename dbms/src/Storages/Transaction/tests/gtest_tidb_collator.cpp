...
struct CollatorCases
{
    ...
    template <typename T>
    using Answer = std::tuple<T, T, T, T, T, T>;
...
const typename CollatorCases::PatternCase CollatorCases::pattern_cases[] = {
    {"A",
     {{"a", {false, false, true, false, true, true}},
      ...
      {"À", {false, false, true, false, true, true}},
      {"", {false, false, false, false, false, false}}}},
    {"_A",
     {{"aA", {true, true, true, true, true, true}},
      {"ÀA", {false, false, true, true, true, true}},
      {"ÀÀ", {false, false, true, false, true, true}},
      {"", {false, false, false, false, false, false}}}},
    {"%A",
     {{"a", {false, false, true, false, true, true}},
      {"ÀA", {true, true, true, true, true, true}},
      {"À", {false, false, true, false, true, true}},
      {"", {false, false, false, false, false, false}}}},
    {"À",
     {{"a", {false, false, true, false, true, true}},
      {"A", {false, false, true, false, true, true}},
      {"À", {true, true, true, true, true, true}},
      {"", {false, false, false, false, false, false}}}},
    {"_À",
     {{" À", {true, true, true, true, true, true}},
      {"ÀA", {false, false, true, false, true, true}},
      {"ÀÀ", {false, false, true, true, true, true}},
      {"", {false, false, false, false, false, false}}}},
    {"%À",
     {{"À", {true, true, true, true, true, true}},
      {"ÀÀÀ", {true, true, true, true, true, true}},
      {"ÀA", {false, false, true, false, true, true}},
      {"", {false, false, false, false, false, false}}}},
    {"À_",
     {{"À ", {true, true, true, true, true, true}},
      {"ÀAA", {false, false, false, false, false, false}},
      {"À", {false, false, false, false, false, false}},
      {"", {false, false, false, false, false, false}}}},
    {"À%",
     {{"À", {true, true, true, true, true, true}},
      {"ÀÀÀ", {true, true, true, true, true, true}},
      {"AÀ", {false, false, true, false, true, true}},
      {"", {false, false, false, false, false, false}}}},
    {"",
     {{"À", {false, false, false, false, false, false}},
      {"ÀÀÀ", {false, false, false, false, false, false}},
      {"AÀ", {false, false, false, false, false, false}},
      {"", {true, true, true, true, true, true}}}},
    {"%",
     {{"À", {true, true, true, true, true, true}},
      {"ÀÀÀ", {true, true, true, true, true, true}},
      {"AÀ", {true, true, true, true, true, true}},
      {"", {true, true, true, true, true, true}}}},
    {"a_%À",
     {{"ÀÀ", {false, false, false, false, false, false}},
      {"aÀÀ", {true, true, true, true, true, true}},
      {"ÀÀÀÀ", {false, false, true, false, true, true}},
      {"ÀÀÀa", {false, false, true, false, true, true}}}},
    {"À%_a",
     {{"ÀÀ", {false, false, false, false, false, false}},
      {"aÀÀ", {false, false, true, false, true, true}},
      {"ÀÀÀa", {true, true, true, true, true, true}},
      {"aÀÀÀ", {false, false, true, false, true, true}}}},
    {"___a", {{"中a", {true, true, false, false, false, false}}, {"中文字a", {false, false, true, true, true, true}}}},
    {"𐐭", {{"𐐨", {false, false, true, false, false, false}}}},
    {
        "%pending%deposits%",
        {
            {"riously after the carefully pending foxes. deposits are careful", {true, true, true, true, true, true}},
            {"pendingdeposits", {true, true, true, true, true, true}},
            {"pendingdeposits", {true, true, true, true, true, true}},
        },
    },
    {
        ...
        {
            {"1234567\\", {true, true, true, true, true, true}},
            {"1234567", {false, false, false, false, false, false}},
            {"1234567\\1", {false, false, false, false, false, false}},
        },
    },
    {
        "1234567\\910", // `ESCAPE` at middle
        {
            {"1234567\\910", {false, false, false, false, false, false}},
            {"1234567910", {true, true, true, true, true, true}},
        },
    },
    {
        "%__", // test match from end
        {
            {"1", {false, false, false, false, false, false}}, // 1 bytes
            {"À", {true, true, false, false, false, false}}, // 2 bytes
            {"12", {true, true, true, true, true, true}}, // 2 bytes
            {"中", {true, true, false, false, false, false}}, // 3 bytes
            {"À1", {true, true, true, true, true, true}}, // 3 bytes
            {"ÀÀ", {true, true, true, true, true, true}}, // 4 bytes
            {"𒀈", {true, true, false, false, false, false}}, // 4 bytes 1 char
            {"À中", {true, true, true, true, true, true}}, // 5 bytes
            {"中中", {true, true, true, true, true, true}}, // 6 bytes
        },
    },
    {
        "%__%", // test
    ...
    },
    {
        ...
        {
            {"xx一a二", {true, true, true, true, true, true}},
            {"xx一À二", {false, false, true, true, true, true}},
        },
    },
    {
        "%一_三%四五六%七",
        {
            {"一二三四五七", {false, false, false, false, false, false}},
            {"0一二三四五六.七", {false, false, true, true, true, true}},
            {"一二四五六七", {false, false, false, false, false, false}},
            {"一2三.四五六...七", {true, true, true, true, true, true}},
        },
    },
    {
        "%一_三%",
        {
            {"000一二3", {false, false, false, false, false, false}},
            {"000一", {false, false, false, false, false, false}},
        },
    },
};
