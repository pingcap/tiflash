...
public:
    ...
    // TODO REVIEW: assign is a better name
...
// TODO REVIEW: why initialize term = 5?
static constexpr UInt64 RAFT_INIT_LOG_TERM = 5;
// TODO REVIEW: raft log initialize position should be 0, after received snapshot, the position should move to 5
