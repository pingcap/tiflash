    ...
    EngineStoreServerWrap * tiflash_instance_wrap)
{
    return EngineStoreServerHelper{
        ...
        .fn_ps_create_write_batch = CreateWriteBatch,
        .fn_ps_wb_put_page = WriteBatchPutPage,
        .fn_ps_wb_del_page = WriteBatchDelPage,
        .fn_ps_get_wb_size = GetWriteBatchSize,
        .fn_ps_is_wb_empty = IsWriteBatchEmpty,
        .fn_ps_handle_merge_wb = HandleMergeWriteBatch,
        .fn_ps_handle_clear_wb = HandleClearWriteBatch,
        .fn_ps_handle_consume_wb = HandleConsumeWriteBatch,
        .fn_ps_handle_read_page = HandleReadPage,
        .fn_ps_handle_scan_page = HandleScanPage,
        .fn_ps_handle_get_lower_bound = HandleGetLowerBound,
        .fn_ps_is_ps_empty = IsPSEmpty,
        .fn_ps_handle_purge_ps = HandlePurgePageStorage,
