...
public:
    ...
    bool onSnapshot(RegionPtr new_region, RegionPtr old_region, UInt64 old_region_index, TMTContext & tmt);
    ...
    bool tryApplySnapshot(RegionPtr new_region, Context & context);
