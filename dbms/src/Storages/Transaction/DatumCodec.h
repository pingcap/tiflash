...
/// But be noted that each layer could has their own datum codec implementations other than this file for endianness and specific data types - TiDB does so, thus so does TiFlash.
namespace DB
{
