...
{
public:
    NPageMapParser(bitmaps * bitmap_, PageEntriesEdit * edit_, char * buffer_,UInt64 size) : NPageFileParser(edit_,buffer_,size), bitmap(bitmap_) {};
...
NPageMap::NPageMap(bitmaps * bitmap_, String & file_path_, FileProviderPtr file_provider_)
    : file_provider{file_provider_}, file_path(file_path_), bitmap(bitmap_)
{
