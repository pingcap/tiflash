...
try
{
    ...
    iter++;
    EXPECT_EQ(iter->type, EditRecordType::DEL);
    EXPECT_EQ(iter->page_id, combine(ns_id, 987));
    EXPECT_EQ(iter->version, ver21);
}
CATCH
