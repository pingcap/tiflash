...
public:
    ...
    struct DumpCheckpointOptions
    {
        ...
        /**
         * The entry data on old CheckpointDataFiles with valid rate less than this
         * threshold will be compacted into the new DataFiles generated by this
         * checkpoint
         */
        DM::Remote::RemoteGCThreshold remote_gc_threshold = {};

        /**
         * Maybe this should not be here
         */
        DM::Remote::IDataStorePtr remote_store = nullptr;
    };

    void dumpIncrementalCheckpoint(const DumpCheckpointOptions & options);

    std::unordered_set<String> getRemoteFileIdsNeedCompact(const DM::Remote::RemoteGCThreshold & gc_threshold, DM::Remote::IDataStorePtr remote_store);
