...
public:
    ...
    void traverseImpl(const std::function<void(const DB::Page & page, size_t)> & acceptor, SnapshotPtr snapshot)
        override;
    ...
    void traverse(const std::function<void(const DB::Page & page, size_t num_total)> & acceptor) { return traverseImpl(acceptor, nullptr); }
