...
class PageEntries : public PageEntriesMixin<PageEntries>
    , public DB::stable::MVCC::MultiVersionCountable<PageEntries>
{
public:
    explicit PageEntries(bool is_base_ = true)
        : PageEntriesMixin(true)
        , DB::stable::MVCC::MultiVersionCountable<PageEntries>(this)
    {
        (void)is_base_;
    }
...
public:
    explicit PageEntriesForDelta(bool is_base_)
        ...
        , DB::stable::MVCC::MultiVersionCountableForDelta<PageEntriesForDelta>()
    {
    }
