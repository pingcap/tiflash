    ...
    , log(Logger::get())
{
    ...
    config.retryStrategy = Aws::MakeShared<Aws::Client::SpecifiedRetryableErrorsRetryStrategy>(STS_ASSUME_ROLE_WEB_IDENTITY_LOG_TAG, retryable_errors, 3 /*maxRetries*/);
