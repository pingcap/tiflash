...
VECTORIZED_DIV_LOOP_AVX512_INSTANTIATION(Int64, Int64)
VECTORIZED_DIV_LOOP_AVX512_INSTANTIATION(Int64, Int32)
VECTORIZED_DIV_LOOP_AVX512_INSTANTIATION(Int64, Int16)
VECTORIZED_DIV_LOOP_AVX512_INSTANTIATION(Int64, Int8)

VECTORIZED_DIV_LOOP_AVX512_INSTANTIATION(Int32, Int64)
VECTORIZED_DIV_LOOP_AVX512_INSTANTIATION(Int32, Int32)
VECTORIZED_DIV_LOOP_AVX512_INSTANTIATION(Int32, Int16)
VECTORIZED_DIV_LOOP_AVX512_INSTANTIATION(Int32, Int8)
