...
private:
    ...
    template <typename MonthDiffCalculator, typename ResultCalculator>
    void vector_vector(const ColumnVector<UInt64> & x, const ColumnVector<UInt64> & y, ColumnInt64::Container & result, ColumnUInt8::Container & result_null_map)
    {
    ...
    template <typename MonthDiffCalculator, typename ResultCalculator>
    void vector_constant(const ColumnVector<UInt64> & x, UInt64 y, ColumnInt64::Container & result, ColumnUInt8::Container & result_null_map)
    {
        const auto & x_data = x.getData();
        if (y == 0)
        {
    ...
    template <typename MonthDiffCalculator, typename ResultCalculator>
    void constant_vector(UInt64 x, const ColumnVector<UInt64> & y, ColumnInt64::Container & result, ColumnUInt8::Container & result_null_map)
    {
        const auto & y_data = y.getData();
        if (x == 0)
        {
