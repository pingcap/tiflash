...
struct AddSecondsImpl
{
    ...
    {
        Field packed_uint_value = parseMyDateTime(str, 6, checkTimeValidAllowZeroMonthAndDay);
...
struct AddDaysImpl
{
    ...
    static inline String execute(String str, Int64 delta, const DateLUTImpl & time_zone)
    {
        auto value_and_is_date = parseMyDateTimeAndJudgeIsDate(str, 6, checkTimeValidAllowZeroMonthAndDay);
