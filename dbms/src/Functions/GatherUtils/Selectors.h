// Modified from: https://github.com/ClickHouse/ClickHouse/blob/30fcaeb2a3fff1bf894aae9c776bed7fd83f783f/dbms/src/Functions/GatherUtils/Selectors.h
//
...
{
    explicit ArraySourceSelectorVisitor(Args &&... args)
        : packed_args(args...)
    {}
...
{
    explicit ArraySinkSelectorVisitor(Args &&... args)
        : packed_args(args...)
    {}
...
{
    explicit ValueSourceSelectorVisitor(Args &&... args)
        : packed_args(args...)
    {}
