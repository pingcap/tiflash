...
struct LeastBaseImpl<A, B, false>
{
    ...
    // static void apply(const TiDB::TiDBCollatorPtr & collator[[maybe_unused]], const ColumnString::Chars_t & a_data[[maybe_unused]], const ColumnString::Offsets & a_offsets[[maybe_unused]], const ColumnString::Chars_t & b_data[[maybe_unused]], const ColumnString::Offsets & b_offsets[[maybe_unused]], ColumnString::Chars_t & c_data[[maybe_unused]],
...
struct LeastStringImpl
{
    ...
    // static void apply(const TiDB::TiDBCollatorPtr & collator, const ColumnString::Chars_t & a_data, const ColumnString::Offsets & a_offsets, const ColumnString::Chars_t & b_data, const ColumnString::Offsets & b_offsets, ColumnString::Chars_t & c_data,
