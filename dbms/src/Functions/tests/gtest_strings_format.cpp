...
try
{
    ...
    ASSERT_COLUMN_EQ(
        ...
        executeFunction(
            ...
            createConstColumn<Nullable<Int64>>(8, 3)));
    // const, vector
    ASSERT_COLUMN_EQ(
...
#define DECIMAL_TESTCASE(Decimal, precision)                                                                                                                                                                          \
    do                                                                                                                                                                                                                \
    {                                                                                                                                                                                                                 \
        ...
        ASSERT_COLUMN_EQ(                                                                                                                                                                                             \
            ...
            executeFunction(                                                                                                                                                                                          \
                ...
                createColumn<NullableDecimal>(                                                                                                                                                                        \
                    ...
                    {FieldType(123321000, 4), FieldType(123322000, 4), FieldType(123323000, 4), FieldType(123323000, 4), FieldType(-123323000, 4), FieldType(-9999999, 4), FieldType(-3333330, 4), FieldType(0, 0)}), \
                createColumn<Nullable<Int64>>({4, 0, -1, 31, 5, 1, 2, {}})));                                                                                                                                         \
    } while (false)

    DECIMAL_TESTCASE(Decimal32, 9);
    DECIMAL_TESTCASE(Decimal64, 18);
    DECIMAL_TESTCASE(Decimal128, 38);
    //    DECIMAL_TESTCASE(Decimal256, 65);
