...
TEST_F(Datesub, dateSubStringIntUnitTest)
{
    ...
    ASSERT_COLUMN_EQ(
        ...
        executeFunction("subtractDays", toNullableVec({"20201212121212.0001", "20201212121212.0000001", "20201212121212.000001", "2012-12-12 12:12.01", "20121.000001", "20121.121212"}), toConst(-1)));

    ASSERT_COLUMN_EQ(
        toNullableVec({{}, {}, {}, {}, {}, {}, {}, {}}),
        executeFunction("subtractDays", toNullableVec({"20130229", "20121312", "20120012", "20121200", "20121232", "20121212241212", "20121212126012", "20121212121260"}), toConst(-1)));
    ASSERT_COLUMN_EQ(
        toNullableVec({{}, {}, {}, {}, {}, {}, {}, {}}),
        executeFunction("subtractDays", toNullableVec({"2013-02-29", "2012-13-12", "2012-00-12", "2012-12-00", "2012-12-32", "2012-12-12- 24:12:12", "2012-12-12-12:60:12", "2012-12-12 12:12:60"}), toConst(-1)));

    ASSERT_COLUMN_EQ(
        toNullableVec({"2012-12-13", "2020-12-14", {}, "9992-01-01 12:12:00", "0007-11-26 12:12:12", {}}),
        executeFunction("subtractDays", toNullableVec({"20121212", "20201212", "20201212", "2012-12-12 12-12", "20201212121212", "2012-12-12 12-12"}), toIntVec({-1, -2, -2914289, -2914289, 735250, 735250})));

    ASSERT_COLUMN_EQ(
        toNullableVec({"2012-12-19", "2012-12-19 12:12:12", "2012-12-19", "2012-12-19 12:12:12"}),
        executeFunction("subtractWeeks", toNullableVec({"20121212", "20121212121212", "2012-12-12", "2012-12-12 12:12:12"}), toConst(-1)));

    ASSERT_COLUMN_EQ(
        toNullableVec({"2013-01-12", "2013-01-12 12:12:12", "2013-01-12", "2013-01-12 12:12:12"}),
        executeFunction("subtractMonths", toNullableVec({"20121212", "20121212121212", "2012-12-12", "2012-12-12 12:12:12"}), toConst(-1)));

    ASSERT_COLUMN_EQ(
        toNullableVec({"2013-12-12", "2013-12-12 12:12:12", "2013-12-12", "2013-12-12 12:12:12"}),
        executeFunction("subtractYears", toNullableVec({"20121212", "20121212121212", "2012-12-12", "2012-12-12 12:12:12"}), toConst(-1)));

    ASSERT_COLUMN_EQ(
        toNullableVec({"2012-12-12 01:00:00", "2012-12-12 13:12:12", "2012-12-12 01:00:00", "2012-12-12 13:12:12"}),
        executeFunction("subtractHours", toNullableVec({"20121212", "20121212121212", "2012-12-12", "2012-12-12 12:12:12"}), toConst(-1)));

    ASSERT_COLUMN_EQ(
        toNullableVec({"2012-12-12 00:01:00", "2012-12-12 12:13:12", "2012-12-12 00:01:00", "2012-12-12 12:13:12"}),
        executeFunction("subtractMinutes", toNullableVec({"20121212", "20121212121212", "2012-12-12", "2012-12-12 12:12:12"}), toConst(-1)));
