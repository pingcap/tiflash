...
public:
    ...
    void initData()
    {
        ...
        std::uniform_int_distribution<int64_t> randomer(std::numeric_limits<int64_t>::min(), std::numeric_limits<int64_t>::max());
        Int256 mod_prec_10 = getScaleMultiplier<Int256>(10);
        Int256 mod_prec_12 = getScaleMultiplier<Int256>(12);
        Int256 mod_prec_25 = getScaleMultiplier<Int256>(25);
        Int256 mod_prec_57 = getScaleMultiplier<Int256>(57);
        Int256 mod_prec_60 = getScaleMultiplier<Int256>(60);
        for (int i = 0; i < row_num; ++i)
        {
            tmp_col_int8->insert(Field(static_cast<Int64>(static_cast<Int8>(randomer(eng)))));
            tmp_col_int16->insert(Field(static_cast<Int64>(static_cast<Int16>(randomer(eng)))));
            tmp_col_int32->insert(Field(static_cast<Int64>(static_cast<Int32>(randomer(eng)))));
            tmp_col_int64->insert(Field(static_cast<Int64>(static_cast<Int64>(randomer(eng)))));

            tmp_col_uint8->insert(Field(static_cast<Int64>(static_cast<UInt8>(randomer(eng)))));
            tmp_col_uint16->insert(Field(static_cast<Int64>(static_cast<UInt16>(randomer(eng)))));
            tmp_col_uint32->insert(Field(static_cast<Int64>(static_cast<UInt16>(randomer(eng)))));
            tmp_col_uint64->insert(Field(static_cast<Int64>(static_cast<UInt16>(randomer(eng)))));

            tmp_col_dec_2_1->insert(DecimalField(Decimal(static_cast<Int32>(randomer(eng) % 100)), 1));
            tmp_col_dec_2_1_small->insert(DecimalField(Decimal(static_cast<Int32>(randomer(eng) % 10)), 1));
            tmp_col_dec_10_3->insert(DecimalField(Decimal(static_cast<Int64>(randomer(eng) % mod_prec_10)), 3));
            tmp_col_dec_12_3->insert(DecimalField(Decimal(static_cast<Int64>(randomer(eng) % mod_prec_12)), 3));
            tmp_col_dec_25_3->insert(DecimalField(Decimal(static_cast<Int128>(randomer(eng) % mod_prec_25)), 3));
            tmp_col_dec_57_0->insert(DecimalField(Decimal(static_cast<Int256>(randomer(eng) % mod_prec_57)), 0));
            tmp_col_dec_60_0->insert(DecimalField(Decimal(static_cast<Int256>(randomer(eng) % mod_prec_60)), 0));
            tmp_col_dec_60_5->insert(DecimalField(Decimal(static_cast<Int256>(randomer(eng) % mod_prec_60)), 5));
        }
        ...
        from_col_dec_2_1_small = ColumnWithTypeAndName(std::move(tmp_col_dec_2_1_small), from_type_dec_2_1_small, "from_col_dec_2_1");
...
// decimal(2, 1) -> decimal(2, 2): Need check overflow; CastInterType is Int32
...
// decimal(25, 3) -> decimal(25, 4): Need check overflow; CastInterType is Int128
...
// decimal(2, 1) -> decimal(2, 2): Need check overflow; CastInterType is Int32
CAST_BENCHMARK(CastToDecimalBench, decimal_2_1_small_to_decimal_2_2, from_col_dec_2_1_small, dest_col_dec_2_2);
