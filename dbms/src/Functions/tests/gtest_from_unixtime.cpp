...
try
{
    ...
    std::vector<String> decimal_20_0_string_result{"0000-00-00 00:00:00.000000", "1970-01-01 00:00:00.000000", "2020-10-10 11:11:11.000000", "2038-01-19 03:14:07.000000", "2038-01-19 03:14:08.000000"};
    ...
    /// case 3, func(vector)
    ASSERT_COLUMN_EQ(createNullableColumn<MyDateTime>(decimal_20_0_date_time_result, null_map),
    ...
    for (auto & format_col : second_const_arguments)
    {
        ...
        ASSERT_COLUMN_EQ(result_col, executeFunction(func_name, createColumn<Decimal128>(std::make_tuple(20, 0), decimal_20_0_data), format_col));
    }
    /// case 5, func(nullable(vector))
    ASSERT_COLUMN_EQ(createNullableColumn<MyDateTime>(decimal_20_0_date_time_result, null_map_for_nullable_vector_input),
                     executeFunction(func_name, createNullableColumn<Decimal128>(std::make_tuple(20, 0), decimal_20_0_data, null_map_for_nullable_vector_input)));
    /// case 6, func(nullable(vector), const)
    not_all_null_string_result_vector = createNullableColumn<String>(decimal_20_0_string_result, null_map_for_nullable_vector_input);
    for (auto & format_col : second_const_arguments)
    {
        auto result_col = null_string_result;
        if (format_col.type->onlyNull())
            ...
            result_col = not_all_null_string_result_vector;
        ASSERT_COLUMN_EQ(result_col, executeFunction(func_name, createNullableColumn<Decimal128>(std::make_tuple(20, 0), decimal_20_0_data, null_map_for_nullable_vector_input), format_col));
    }
}
CATCH
...
try
{
    ...
    String format_data = "%Y-%m-%d %H:%i:%s.%f";
    std::vector<String> decimal_20_3_string_result{"0000-00-00 00:00:00.000000", "1970-01-01 00:00:00.123000", "2020-10-10 11:11:11.124000", "2038-01-19 03:14:07.123000", "2038-01-19 03:14:08.123000"};
    std::vector<Int32> null_map{1, 0, 0, 0, 1};

    ASSERT_COLUMN_EQ(createNullableColumn<MyDateTime>(std::make_tuple(3), decimal_20_3_date_time_result, null_map),
                     executeFunction(func_name, createColumn<Decimal128>(std::make_tuple(20, 3), decimal_20_3_data)));
    ASSERT_COLUMN_EQ(createNullableColumn<String>(decimal_20_3_string_result, null_map),
                     executeFunction(func_name, createColumn<Decimal128>(std::make_tuple(20, 3), decimal_20_3_data), createConstColumn<String>(5, format_data)));

    std::vector<String> decimal_20_6_data{"-1.000000", "0.123456", "1602328271.123456", "2147483647.123456", "2147483648.123456"};
    ...
    std::vector<String> decimal_20_6_string_result{"0000-00-00 00:00:00.000000", "1970-01-01 00:00:00.123456", "2020-10-10 11:11:11.123456", "2038-01-19 03:14:07.123456", "2038-01-19 03:14:08.123456"};

    ASSERT_COLUMN_EQ(createNullableColumn<MyDateTime>(std::make_tuple(6), decimal_20_6_date_time_result, null_map),
                     executeFunction(func_name, createColumn<Decimal128>(std::make_tuple(20, 6), decimal_20_6_data)));
    ASSERT_COLUMN_EQ(createNullableColumn<String>(decimal_20_6_string_result, null_map),
                     executeFunction(func_name, createColumn<Decimal128>(std::make_tuple(20, 6), decimal_20_6_data), createConstColumn<String>(5, format_data)));

    ASSERT_COLUMN_EQ(createNullableColumn<MyDateTime>(std::make_tuple(6), decimal_20_6_date_time_result, null_map),
                     executeFunction(func_name, createColumn<Decimal256>(std::make_tuple(40, 6), decimal_20_6_data)));
    ASSERT_COLUMN_EQ(createNullableColumn<String>(decimal_20_6_string_result, null_map),
                     executeFunction(func_name, createColumn<Decimal256>(std::make_tuple(40, 6), decimal_20_6_data), createConstColumn<String>(5, format_data)));
    ...
    std::vector<String> decimal_18_0_string_result{"0000-00-00 00:00:00.000000", "1970-01-01 00:00:00.000000", "2020-10-10 11:11:11.000000", "2038-01-19 03:14:07.000000", "2038-01-19 03:14:08.000000"};
    ASSERT_COLUMN_EQ(createNullableColumn<MyDateTime>(std::make_tuple(0), decimal_18_0_date_time_result, null_map),
                     executeFunction(func_name, createColumn<Decimal64>(std::make_tuple(18, 0), decimal_18_0_data)));
    ASSERT_COLUMN_EQ(createNullableColumn<String>(decimal_18_0_string_result, null_map),
                     executeFunction(func_name, createColumn<Decimal64>(std::make_tuple(18, 0), decimal_18_0_data), createConstColumn<String>(5, format_data)));
    ...
    std::vector<String> decimal_8_0_string_result{"0000-00-00 00:00:00.000000", "1970-01-01 00:00:00.000000", "1970-07-05 10:54:42.000000", "1970-09-06 13:13:56.000000"};
    ASSERT_COLUMN_EQ(createNullableColumn<MyDateTime>(std::make_tuple(0), decimal_8_0_date_time_result, null_map),
                     executeFunction(func_name, createColumn<Decimal32>(std::make_tuple(8, 0), decimal_8_0_data)));
    ASSERT_COLUMN_EQ(createNullableColumn<String>(decimal_8_0_string_result, null_map),
                     executeFunction(func_name, createColumn<Decimal32>(std::make_tuple(8, 0), decimal_8_0_data), createConstColumn<String>(5, format_data)));
}
CATCH
