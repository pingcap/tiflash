...
TEST_F(TestFunctionsRoundWithFrac, PrecisionInfer)
{
    ...
    EXPECT_EQ(infer(9, 3, 2, true, false), Result(9, 2));
    EXPECT_EQ(infer(9, 3, 1, true, false), Result(8, 1));
    EXPECT_EQ(infer(9, 3, 0, true, false), Result(7, 0));
    EXPECT_EQ(infer(9, 3, -1, true, false), Result(7, 0));
    EXPECT_EQ(infer(9, 3, -2, true, false), Result(7, 0));
    EXPECT_EQ(infer(9, 3, 40, true, false), Result(36, 30));
    EXPECT_EQ(infer(9, 3, -100, true, false), Result(7, 0));
    EXPECT_EQ(infer(9, 3, 0, false, false), Result(10, 3));
    EXPECT_EQ(infer(9, 3, 233, false, false), Result(10, 3));

    EXPECT_EQ(infer(18, 6, 2, true, false), Result(15, 2));
    EXPECT_EQ(infer(18, 6, 1, true, false), Result(14, 1));
    EXPECT_EQ(infer(18, 6, 0, true, false), Result(13, 0));
    EXPECT_EQ(infer(18, 6, -1, true, false), Result(13, 0));
    EXPECT_EQ(infer(18, 6, -2, true, false), Result(13, 0));
    EXPECT_EQ(infer(18, 6, 40, true, false), Result(42, 30));
    EXPECT_EQ(infer(18, 6, -100, true, false), Result(13, 0));
    EXPECT_EQ(infer(18, 6, 0, false, false), Result(19, 6));
    EXPECT_EQ(infer(18, 6, -233, false, false), Result(19, 6));

    EXPECT_EQ(infer(30, 30, 2, true, false), Result(3, 2));
    EXPECT_EQ(infer(30, 30, 1, true, false), Result(2, 1));
    EXPECT_EQ(infer(30, 30, 0, true, false), Result(1, 0));
    EXPECT_EQ(infer(30, 30, -1, true, false), Result(1, 0));
    EXPECT_EQ(infer(30, 30, -2, true, false), Result(1, 0));
    EXPECT_EQ(infer(30, 30, 40, true, false), Result(30, 30));
    EXPECT_EQ(infer(30, 30, -100, true, false), Result(1, 0));
    EXPECT_EQ(infer(30, 30, 0, false, false), Result(31, 30));
    EXPECT_EQ(infer(30, 30, 233, false, false), Result(31, 30));

    EXPECT_EQ(infer(64, 0, 40, true, false), Result(65, 30));
    EXPECT_EQ(infer(64, 0, -100, true, false), Result(65, 0));
    EXPECT_EQ(infer(64, 0, -62, true, false), Result(65, 0));
    EXPECT_EQ(infer(64, 0, -63, true, false), Result(65, 0));
    EXPECT_EQ(infer(64, 0, -64, true, false), Result(65, 0));
    EXPECT_EQ(infer(64, 0, -65, true, false), Result(65, 0));
    EXPECT_EQ(infer(64, 0, -66, true, false), Result(65, 0));
    EXPECT_EQ(infer(64, 0, 0, false, false), Result(65, 0));
    EXPECT_EQ(infer(64, 0, 233, false, false), Result(65, 0));

    EXPECT_EQ(infer(65, 30, 40, true, false), Result(65, 30));
    EXPECT_EQ(infer(65, 30, -100, true, false), Result(36, 0));
    EXPECT_EQ(infer(65, 30, 0, false, false), Result(65, 30));
    EXPECT_EQ(infer(65, 30, 233, false, false), Result(65, 30));

    EXPECT_EQ(infer(65, 0, 233, false, false), Result(65, 0));
    EXPECT_EQ(infer(65, 1, 233, false, false), Result(65, 1));
    EXPECT_EQ(infer(64, 0, 233, false, false), Result(65, 0));

    EXPECT_EQ(infer(18, 6, 4, true, false), Result(17, 4));
    EXPECT_EQ(infer(18, 6, 5, true, false), Result(18, 5));
    EXPECT_EQ(infer(18, 6, 6, true, false), Result(18, 6));
    EXPECT_EQ(infer(18, 6, 7, true, false), Result(19, 7));
    EXPECT_EQ(infer(18, 6, 8, true, false), Result(20, 8));
}
