...
TEST_F(StringPad, string_pad_string_unit_Test)
{
	...
	ColumnWithTypeAndName
		ctn = ColumnWithTypeAndName(std::move(csp), std::make_shared<DataTypeString>(), "test_pad_1");
	ColumnWithTypeAndName
		ctn2 = ColumnWithTypeAndName(csp2, std::make_shared<DataTypeInt64>(), "test_pad_2");
	ColumnWithTypeAndName
		ctn3 = ColumnWithTypeAndName(csp3, std::make_shared<DataTypeString>(), "test_pad_3");
...
TEST_F(StringPad, string_pad_const_string_unit_Test)
{
	...
	Block testBlock;
	ColumnWithTypeAndName
		ctn = ColumnWithTypeAndName(csp, std::make_shared<DataTypeString>(), "test_pad_1");
	ColumnWithTypeAndName
		ctn2 = ColumnWithTypeAndName(csp2, std::make_shared<DataTypeInt64>(), "test_pad_2");
	ColumnWithTypeAndName
		ctn3 = ColumnWithTypeAndName(csp3, std::make_shared<DataTypeString>(), "test_pad_3");
...
TEST_F(StringPad, string_pad_fixed_utf8_padding_unit_Test)
{
	...
	Block testBlock;
	ColumnWithTypeAndName
		ctn = ColumnWithTypeAndName(std::move(csp), std::make_shared<DataTypeFixedString>(10), "test_pad_1");
	ColumnWithTypeAndName
		ctn2 = ColumnWithTypeAndName(csp2, std::make_shared<DataTypeInt64>(), "test_pad_2");
	ColumnWithTypeAndName
		ctn3 = ColumnWithTypeAndName(csp3, std::make_shared<DataTypeString>(), "test_pad_3");
...
TEST_F(StringPad, string_pad_const_fixed_utf8_padding_unit_Test)
{
    ...
    Block testBlock;
    ColumnWithTypeAndName
        ctn = ColumnWithTypeAndName(csp, std::make_shared<DataTypeFixedString>(30), "test_pad_1");
    ColumnWithTypeAndName
        ctn2 = ColumnWithTypeAndName(csp2, std::make_shared<DataTypeInt64>(), "test_pad_2");
    ColumnWithTypeAndName
        ctn3 = ColumnWithTypeAndName(csp3, std::make_shared<DataTypeString>(), "test_pad_3");
