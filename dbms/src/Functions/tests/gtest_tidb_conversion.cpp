...
auto createCastTypeConstColumn(String str) { return createConstColumn<String>(1, str); }
...
public:
    ...
    void testNotOnlyNull(const Input & input, const Output & output)
    {
        ...
        auto inner_test = [&](bool is_const) {
            ASSERT_COLUMN_EQ(is_const ? createConstColumn<Nullable<Output>>(1, output) : createColumn<Nullable<Output>>({output}),
    ...
    typename std::enable_if<IsDecimal<Output>, void>::type testNotOnlyNull(
        const Input & input, const DecimalField<Output> & output, const std::tuple<UInt32, UInt32> & meta)
    {
        auto inner_test = [&](bool is_const) {
            ASSERT_COLUMN_EQ(
    ...
    typename std::enable_if<std::is_same_v<Output, MyDateTime>, void>::type testNotOnlyNull(
        const Input & input, const MyDateTime & output, int fraction)
    {
        auto inner_test = [&](bool is_const) {
            ASSERT_COLUMN_EQ(is_const ? createDateTimeColumnConst(1, output, fraction) : createDateTimeColumn({output}, fraction),
                executeFunction(func_name,
                    {is_const ? createConstColumn<Nullable<Input>>(1, input) : createColumn<Nullable<Input>>({input}),
    ...
    void testOnlyNull()
    {
        std::vector<ColumnWithTypeAndName> nulls = {createOnlyNullColumnConst(1), createOnlyNullColumn(1),
            createColumn<Nullable<Input>>({{}}), createConstColumn<Nullable<Input>>(1, {})};
        ...
        auto inner_test = [&](const ColumnWithTypeAndName & null_one) {
            if constexpr (IsDecimal<Output>)
            {
                ...
                ASSERT_COLUMN_EQ(res,
                    executeFunction(func_name, {null_one, createCastTypeConstColumn(fmt::format("Nullable(Decimal({},0))", precision))}));
            }
            else if constexpr (std::is_same_v<Output, MyDateTime>)
            {
                ...
                ASSERT_COLUMN_EQ(res, executeFunction(func_name, {null_one, createCastTypeConstColumn("Nullable(MyDateTime(6))")}));
            }
            else
            {
                auto res
                    = null_one.column->isColumnConst() ? createConstColumn<Nullable<Output>>(1, {}) : createColumn<Nullable<Output>>({{}});
                ASSERT_COLUMN_EQ(res,
                    executeFunction(
                        func_name, {null_one, createCastTypeConstColumn(fmt::format("Nullable({})", TypeName<Output>::get()))}));
            }
        };
...
try
{
    ...
    ASSERT_COLUMN_EQ(createConstColumn<Int64>(1, -1),
    ...
    ASSERT_COLUMN_EQ(createConstColumn<Int64>(1, MAX_INT8),
        executeFunction(func_name, {createConstColumn<Int8>(1, MAX_INT8), createCastTypeConstColumn("Int64")}));
    ASSERT_COLUMN_EQ(createConstColumn<Int64>(1, MAX_INT16),
        executeFunction(func_name, {createConstColumn<Int16>(1, MAX_INT16), createCastTypeConstColumn("Int64")}));
    ASSERT_COLUMN_EQ(createConstColumn<Int64>(1, MAX_INT32),
        executeFunction(func_name, {createConstColumn<Int32>(1, MAX_INT32), createCastTypeConstColumn("Int64")}));
    ASSERT_COLUMN_EQ(createConstColumn<Int64>(1, MAX_INT64),
        executeFunction(func_name, {createConstColumn<Int64>(1, MAX_INT64), createCastTypeConstColumn("Int64")}));

    /// normal cases
    // uint8/16/32/64 -> uint64, no overflow
    ASSERT_COLUMN_EQ(createColumn<Nullable<UInt64>>({0, 1, MAX_UINT8, {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt8>>({0, 1, MAX_UINT8, {}}), createCastTypeConstColumn("Nullable(UInt64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<UInt64>>({0, 1, MAX_UINT16, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt16>>({0, 1, MAX_UINT16, {}}), createCastTypeConstColumn("Nullable(UInt64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<UInt64>>({0, 1, MAX_UINT32, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt32>>({0, 1, MAX_UINT32, {}}), createCastTypeConstColumn("Nullable(UInt64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<UInt64>>({0, 1, MAX_UINT64, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt64>>({0, 1, MAX_UINT64, {}}), createCastTypeConstColumn("Nullable(UInt64)")}));
    // int8/16/32/64 -> uint64, no overflow
    ASSERT_COLUMN_EQ(createColumn<Nullable<UInt64>>({0, MAX_INT8, MAX_UINT64, MAX_UINT64 - MAX_INT8, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int8>>({0, MAX_INT8, -1, MIN_INT8, {}}), createCastTypeConstColumn("Nullable(UInt64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<UInt64>>({0, MAX_INT16, MAX_UINT64, MAX_UINT64 - MAX_INT16, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int16>>({0, MAX_INT16, -1, MIN_INT16, {}}), createCastTypeConstColumn("Nullable(UInt64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<UInt64>>({0, MAX_INT32, MAX_UINT64, MAX_UINT64 - MAX_INT32, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int32>>({0, MAX_INT32, -1, MIN_INT32, {}}), createCastTypeConstColumn("Nullable(UInt64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<UInt64>>({0, MAX_INT64, MAX_UINT64, MAX_UINT64 - MAX_INT64, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int64>>({0, MAX_INT64, -1, MIN_INT64, {}}), createCastTypeConstColumn("Nullable(UInt64)")}));
    // uint8/16/32 -> int64, no overflow
    ASSERT_COLUMN_EQ(createColumn<Nullable<Int64>>({0, MAX_INT8, MAX_UINT8, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt8>>({0, MAX_INT8, MAX_UINT8, {}}), createCastTypeConstColumn("Nullable(Int64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Int64>>({0, MAX_INT16, MAX_UINT16, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt16>>({0, MAX_INT16, MAX_UINT16, {}}), createCastTypeConstColumn("Nullable(Int64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Int64>>({0, MAX_INT32, MAX_UINT32, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt32>>({0, MAX_INT32, MAX_UINT32, {}}), createCastTypeConstColumn("Nullable(Int64)")}));
    //  uint64 -> int64, overflow may happen
    ASSERT_COLUMN_EQ(createColumn<Nullable<Int64>>({0, MAX_INT64, -1, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt64>>({0, MAX_INT64, MAX_UINT64, {}}), createCastTypeConstColumn("Nullable(Int64)")}));
    // int8/16/32/64 -> int64, no overflow
    ASSERT_COLUMN_EQ(createColumn<Nullable<Int64>>({0, MAX_INT8, -1, MIN_INT8, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int8>>({0, MAX_INT8, -1, MIN_INT8, {}}), createCastTypeConstColumn("Nullable(Int64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Int64>>({0, MAX_INT16, -1, MIN_INT16, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int16>>({0, MAX_INT16, -1, MIN_INT16, {}}), createCastTypeConstColumn("Nullable(Int64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Int64>>({0, MAX_INT32, -1, MIN_INT32, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int32>>({0, MAX_INT32, -1, MIN_INT32, {}}), createCastTypeConstColumn("Nullable(Int64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Int64>>({0, MAX_INT64, -1, MIN_INT64, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int64>>({0, MAX_INT64, -1, MIN_INT64, {}}), createCastTypeConstColumn("Nullable(Int64)")}));
}
CATCH
...
try
{
    ...
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({1234567890.0, 123456789012345680.0, 0.0, {}}),
        executeFunction(func_name,
            {createColumn<Nullable<UInt64>>({1234567890, // this is fine
    ...
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({1234567890.0, 123456789012345680.0, 0.0, {}}),
        executeFunction(func_name,
            {createColumn<Nullable<Int64>>({1234567890, // this is fine
                 123456789012345678,                    // but this cannot be represented precisely in the IEEE 754 64-bit float format
                 0, {}}),
                createCastTypeConstColumn("Nullable(Float64)")}));
    // uint32/16/8 and int32/16/8 -> float64, precise
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({MAX_UINT32, 0, {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt32>>({MAX_UINT32, 0, {}}), createCastTypeConstColumn("Nullable(Float64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({MAX_UINT16, 0, {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt16>>({MAX_UINT16, 0, {}}), createCastTypeConstColumn("Nullable(Float64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({MAX_UINT8, 0, {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt8>>({MAX_UINT8, 0, {}}), createCastTypeConstColumn("Nullable(Float64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({MAX_INT32, MIN_INT32, 0, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int32>>({MAX_INT32, MIN_INT32, 0, {}}), createCastTypeConstColumn("Nullable(Float64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({MAX_INT16, MIN_INT16, 0, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int16>>({MAX_INT16, MIN_INT16, 0, {}}), createCastTypeConstColumn("Nullable(Float64)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({MAX_INT8, MIN_INT8, 0, {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int8>>({MAX_INT8, MIN_INT8, 0, {}}), createCastTypeConstColumn("Nullable(Float64)")}));
}
CATCH
...
try
{
    ...
    ASSERT_COLUMN_EQ(createConstColumn<String>(1, "18446744073709551615"),
        executeFunction(func_name, {createConstColumn<UInt64>(1, MAX_UINT64), createCastTypeConstColumn("String")}));
    ASSERT_COLUMN_EQ(createConstColumn<String>(1, "4294967295"),
        executeFunction(func_name, {createConstColumn<UInt32>(1, MAX_UINT32), createCastTypeConstColumn("String")}));
    ASSERT_COLUMN_EQ(createConstColumn<String>(1, "65535"),
        executeFunction(func_name, {createConstColumn<UInt16>(1, MAX_UINT16), createCastTypeConstColumn("String")}));
    ASSERT_COLUMN_EQ(createConstColumn<String>(1, "255"),
        executeFunction(func_name, {createConstColumn<UInt8>(1, MAX_UINT8), createCastTypeConstColumn("String")}));
    // int64/32/16/8 -> string
    ASSERT_COLUMN_EQ(createConstColumn<String>(1, "9223372036854775807"),
        executeFunction(func_name, {createConstColumn<Int64>(1, MAX_INT64), createCastTypeConstColumn("String")}));
    ASSERT_COLUMN_EQ(createConstColumn<String>(1, "2147483647"),
        executeFunction(func_name, {createConstColumn<Int32>(1, MAX_INT32), createCastTypeConstColumn("String")}));
    ASSERT_COLUMN_EQ(createConstColumn<String>(1, "32767"),
        executeFunction(func_name, {createConstColumn<Int16>(1, MAX_INT16), createCastTypeConstColumn("String")}));
    ASSERT_COLUMN_EQ(createConstColumn<String>(1, "127"),
        executeFunction(func_name, {createConstColumn<Int8>(1, MAX_INT8), createCastTypeConstColumn("String")}));

    /// normal cases
    // uint64/32/16/8 -> string
    ASSERT_COLUMN_EQ(createColumn<Nullable<String>>({"18446744073709551615", "0", {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt64>>({MAX_UINT64, 0, {}}), createCastTypeConstColumn("Nullable(String)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<String>>({"4294967295", "0", {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt32>>({MAX_UINT32, 0, {}}), createCastTypeConstColumn("Nullable(String)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<String>>({"65535", "0", {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt16>>({MAX_UINT16, 0, {}}), createCastTypeConstColumn("Nullable(String)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<String>>({"255", "0", {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt8>>({MAX_UINT8, 0, {}}), createCastTypeConstColumn("Nullable(String)")}));
    // int64/32/16/8 -> string
    ASSERT_COLUMN_EQ(createColumn<Nullable<String>>({"9223372036854775807", "-9223372036854775808", "0", {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int64>>({MAX_INT64, MIN_INT64, 0, {}}), createCastTypeConstColumn("Nullable(String)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<String>>({"2147483647", "-2147483648", "0", {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int32>>({MAX_INT32, MIN_INT32, 0, {}}), createCastTypeConstColumn("Nullable(String)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<String>>({"32767", "-32768", "0", {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int16>>({MAX_INT16, MIN_INT16, 0, {}}), createCastTypeConstColumn("Nullable(String)")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<String>>({"127", "-128", "0", {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int8>>({MAX_INT8, MIN_INT8, 0, {}}), createCastTypeConstColumn("Nullable(String)")}));
}
CATCH
...
try
{
    ...
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal32>>(std::make_tuple(9, 0), {DecimalField32(MAX_INT8, 0), DecimalField32(MIN_INT8, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int8>>({MAX_INT8, MIN_INT8, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}));
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal64>>(std::make_tuple(18, 0), {DecimalField64(MAX_INT8, 0), DecimalField64(MIN_INT8, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int8>>({MAX_INT8, MIN_INT8, {}}), createCastTypeConstColumn("Nullable(Decimal(18,0))")}));
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal128>>(std::make_tuple(38, 0), {DecimalField128(MAX_INT8, 0), DecimalField128(MIN_INT8, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int8>>({MAX_INT8, MIN_INT8, {}}), createCastTypeConstColumn("Nullable(Decimal(38,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal256>>(std::make_tuple(65, 0),
                         {DecimalField256(static_cast<Int256>(MAX_INT8), 0), DecimalField256(static_cast<Int256>(MIN_INT8), 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int8>>({MAX_INT8, MIN_INT8, {}}), createCastTypeConstColumn("Nullable(Decimal(65,0))")}));
    // int16 -> decimal32/64/128/256
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal32>>(std::make_tuple(9, 0), {DecimalField32(MAX_INT16, 0), DecimalField32(MIN_INT16, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int16>>({MAX_INT16, MIN_INT16, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}));
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal64>>(std::make_tuple(18, 0), {DecimalField64(MAX_INT16, 0), DecimalField64(MIN_INT16, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int16>>({MAX_INT16, MIN_INT16, {}}), createCastTypeConstColumn("Nullable(Decimal(18,0))")}));
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal128>>(std::make_tuple(38, 0), {DecimalField128(MAX_INT16, 0), DecimalField128(MIN_INT16, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int16>>({MAX_INT16, MIN_INT16, {}}), createCastTypeConstColumn("Nullable(Decimal(38,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal256>>(std::make_tuple(65, 0),
                         {DecimalField256(static_cast<Int256>(MAX_INT16), 0), DecimalField256(static_cast<Int256>(MIN_INT16), 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int16>>({MAX_INT16, MIN_INT16, {}}), createCastTypeConstColumn("Nullable(Decimal(65,0))")}));
    // int32 -> decimal32/64/128/256
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal32>>(std::make_tuple(9, 0), {DecimalField32(999999999, 0), DecimalField32(-999999999, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int32>>({999999999, -999999999, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}));
    ASSERT_THROW(executeFunction(func_name,
                     {createColumn<Nullable<Int32>>({1000000000, -1000000000, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}),
        TiFlashException);
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal64>>(std::make_tuple(18, 0), {DecimalField64(MAX_INT32, 0), DecimalField64(MIN_INT32, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int32>>({MAX_INT32, MIN_INT32, {}}), createCastTypeConstColumn("Nullable(Decimal(18,0))")}));
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal128>>(std::make_tuple(38, 0), {DecimalField128(MAX_INT32, 0), DecimalField128(MIN_INT32, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int32>>({MAX_INT32, MIN_INT32, {}}), createCastTypeConstColumn("Nullable(Decimal(38,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal256>>(std::make_tuple(65, 0),
                         {DecimalField256(static_cast<Int256>(MAX_INT32), 0), DecimalField256(static_cast<Int256>(MIN_INT32), 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int32>>({MAX_INT32, MIN_INT32, {}}), createCastTypeConstColumn("Nullable(Decimal(65,0))")}));
    // int64 -> decimal32/64/128/256
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal32>>(std::make_tuple(9, 0), {DecimalField32(999999999, 0), DecimalField32(-999999999, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int64>>({999999999, -999999999, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}));
    ASSERT_THROW(executeFunction(func_name,
                     {createColumn<Nullable<Int64>>({1000000000, -1000000000, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}),
        TiFlashException);
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal64>>(
                         std::make_tuple(18, 0), {DecimalField64(999999999999999999, 0), DecimalField64(-999999999999999999, 0), {}}),
        executeFunction(func_name,
    ...
    ASSERT_THROW(executeFunction(func_name,
        ...
        TiFlashException);
    ASSERT_COLUMN_EQ(
        createColumn<Nullable<Decimal128>>(std::make_tuple(38, 0), {DecimalField128(MAX_INT64, 0), DecimalField128(MIN_INT64, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int64>>({MAX_INT64, MIN_INT64, {}}), createCastTypeConstColumn("Nullable(Decimal(38,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal256>>(std::make_tuple(65, 0),
                         {DecimalField256(static_cast<Int256>(MAX_INT64), 0), DecimalField256(static_cast<Int256>(MIN_INT64), 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<Int64>>({MAX_INT64, MIN_INT64, {}}), createCastTypeConstColumn("Nullable(Decimal(65,0))")}));
    // uint8 -> decimal32/64/128/256
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal32>>(std::make_tuple(9, 0), {DecimalField32(MAX_UINT8, 0), {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt8>>({MAX_UINT8, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal64>>(std::make_tuple(18, 0), {DecimalField64(MAX_UINT8, 0), {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt8>>({MAX_UINT8, {}}), createCastTypeConstColumn("Nullable(Decimal(18,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal128>>(std::make_tuple(38, 0), {DecimalField128(MAX_UINT8, 0), {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt8>>({MAX_UINT8, {}}), createCastTypeConstColumn("Nullable(Decimal(38,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal256>>(std::make_tuple(65, 0), {DecimalField256(static_cast<Int256>(MAX_UINT8), 0), {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt8>>({MAX_UINT8, {}}), createCastTypeConstColumn("Nullable(Decimal(65,0))")}));
    // uint16 -> decimal32/64/128/256
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal32>>(std::make_tuple(9, 0), {DecimalField32(MAX_UINT16, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt16>>({MAX_UINT16, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal64>>(std::make_tuple(18, 0), {DecimalField64(MAX_UINT16, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt16>>({MAX_UINT16, {}}), createCastTypeConstColumn("Nullable(Decimal(18,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal128>>(std::make_tuple(38, 0), {DecimalField128(MAX_UINT16, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt16>>({MAX_UINT16, {}}), createCastTypeConstColumn("Nullable(Decimal(38,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal256>>(std::make_tuple(65, 0), {DecimalField256(static_cast<Int256>(MAX_UINT16), 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt16>>({MAX_UINT16, {}}), createCastTypeConstColumn("Nullable(Decimal(65,0))")}));
    // uint32 -> decimal32/64/128/256
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal32>>(std::make_tuple(9, 0), {DecimalField32(999999999, 0), {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt32>>({999999999, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}));
    ASSERT_THROW(
        executeFunction(func_name, {createColumn<Nullable<UInt32>>({1000000000, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}),
        TiFlashException);
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal64>>(std::make_tuple(18, 0), {DecimalField64(MAX_UINT32, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt32>>({MAX_UINT32, {}}), createCastTypeConstColumn("Nullable(Decimal(18,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal128>>(std::make_tuple(38, 0), {DecimalField128(MAX_UINT32, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt32>>({MAX_UINT32, {}}), createCastTypeConstColumn("Nullable(Decimal(38,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal256>>(std::make_tuple(65, 0), {DecimalField256(static_cast<Int256>(MAX_UINT32), 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt32>>({MAX_UINT32, {}}), createCastTypeConstColumn("Nullable(Decimal(65,0))")}));
    // uint64 -> decimal32/64/128/256
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal32>>(std::make_tuple(9, 0), {DecimalField32(999999999, 0), {}}),
        executeFunction(func_name, {createColumn<Nullable<UInt64>>({999999999, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}));
    ASSERT_THROW(
        executeFunction(func_name, {createColumn<Nullable<UInt64>>({1000000000, {}}), createCastTypeConstColumn("Nullable(Decimal(9,0))")}),
        TiFlashException);
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal64>>(std::make_tuple(18, 0), {DecimalField64(999999999999999999, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt64>>({999999999999999999, {}}), createCastTypeConstColumn("Nullable(Decimal(18,0))")}));
    ASSERT_THROW(executeFunction(func_name,
                     {createColumn<Nullable<UInt64>>({1000000000000000000, {}}), createCastTypeConstColumn("Nullable(Decimal(18,0))")}),
        TiFlashException);
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal128>>(std::make_tuple(38, 0), {DecimalField128(MAX_INT64, 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt64>>({MAX_INT64, {}}), createCastTypeConstColumn("Nullable(Decimal(38,0))")}));
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal256>>(std::make_tuple(65, 0), {DecimalField256(static_cast<Int256>(MAX_INT64), 0), {}}),
        executeFunction(
            func_name, {createColumn<Nullable<UInt64>>({MAX_INT64, {}}), createCastTypeConstColumn("Nullable(Decimal(65,0))")}));

    ASSERT_THROW(executeFunction(func_name, {createColumn<Nullable<Int32>>({9999}), createCastTypeConstColumn("Nullable(Decimal(4, 1))")}),
        TiFlashException);

    ASSERT_THROW(executeFunction(func_name, {createColumn<Nullable<Int32>>({-9999}), createCastTypeConstColumn("Nullable(Decimal(4, 1))")}),
        TiFlashException);

    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal32>>(std::make_tuple(4, 1), {DecimalField32(static_cast<Int32>(9990), 1)}),
        executeFunction(func_name, {createColumn<Nullable<Int32>>({999}), createCastTypeConstColumn("Nullable(Decimal(4, 1))")}));
    ...
    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal32>>(std::make_tuple(4, 1), {DecimalField32(static_cast<Int32>(9999), 1)}),
        executeFunction(func_name, {createColumn<Nullable<Int32>>({9999}), createCastTypeConstColumn("Nullable(Decimal(4, 1))")}));

    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal32>>(std::make_tuple(4, 1), {DecimalField32(static_cast<Int32>(-9999), 1)}),
        executeFunction(func_name, {createColumn<Nullable<Int32>>({-9999}), createCastTypeConstColumn("Nullable(Decimal(4, 1))")}));

    ASSERT_COLUMN_EQ(createColumn<Nullable<Decimal32>>(std::make_tuple(2, 2), {DecimalField32(static_cast<Int32>(99), 2)}),
        executeFunction(func_name, {createColumn<Nullable<Int32>>({9999}), createCastTypeConstColumn("Nullable(Decimal(2, 2))")}));
...
try
{
    ASSERT_COLUMN_EQ(createDateTimeColumn({{}, {{2021, 10, 26, 16, 8, 59, 0}}}, 6),
        executeFunction(
            func_name, {createColumn<Nullable<Int64>>({{}, 20211026160859}), createCastTypeConstColumn("Nullable(MyDateTime(6))")}));
    ASSERT_COLUMN_EQ(createDateTimeColumn({{}, {{2021, 10, 26, 16, 8, 59, 0}}}, 6),
        executeFunction(
            func_name, {createColumn<Nullable<UInt64>>({{}, 20211026160859}), createCastTypeConstColumn("Nullable(MyDateTime(6))")}));
    ASSERT_THROW(
        executeFunction(func_name, {createColumn<Nullable<UInt8>>({MAX_UINT8}), createCastTypeConstColumn("Nullable(MyDateTime(6))")}),
        TiFlashException);
    ASSERT_THROW(
        executeFunction(func_name, {createColumn<Nullable<UInt16>>({MAX_UINT16}), createCastTypeConstColumn("Nullable(MyDateTime(6))")}),
        TiFlashException);
    ASSERT_THROW(
        executeFunction(func_name, {createColumn<Nullable<UInt32>>({MAX_UINT32}), createCastTypeConstColumn("Nullable(MyDateTime(6))")}),
        TiFlashException);
    ASSERT_COLUMN_EQ(createDateTimeColumn({{}}, 6),
        executeFunction(func_name, {createColumn<Nullable<UInt64>>({0}), createCastTypeConstColumn("Nullable(MyDateTime(6))")}));
    ASSERT_THROW(executeFunction(func_name,
                     {createColumn<Nullable<Int64>>({{}, -20211026160859}), createCastTypeConstColumn("Nullable(MyDateTime(6))")}),
        TiFlashException);
}
CATCH
...
try
{
    ...
    ASSERT_COLUMN_EQ(createColumn<Float64>({datetime_float, datetime_frac_float}),
    ...
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({datetime_float, datetime_frac_float}),
    ...
    ASSERT_COLUMN_EQ(createColumn<Nullable<Float64>>({datetime_float, {}}),
    ...
    ASSERT_COLUMN_EQ(createConstColumn<Float64>(1, datetime_float),
    ...
    ASSERT_COLUMN_EQ(createConstColumn<Nullable<Float64>>(1, datetime_float),
...
try
{
    ...
    ColumnWithTypeAndName input(
        createColumn<DataTypeMyDuration::FieldType>(
            {(20 * 3600 + 20 * 60 + 20) * 1000000000L + 555000000L, -(20 * 3600 + 20 * 60 + 20) * 1000000000L - 555000000L,
                (20 * 3600 + 20 * 60 + 20) * 1000000000L + 554000000L, -(20 * 3600 + 20 * 60 + 20) * 1000000000L - 554000000L,
                (20 * 3600 + 20 * 60 + 20) * 1000000000L + 999000000L, -(20 * 3600 + 20 * 60 + 20) * 1000000000L - 999000000L})
            .column,
        from_type,
        "input");
    ...
    ColumnWithTypeAndName output3(
        createColumn<DataTypeMyDuration::FieldType>(
            {(20 * 3600 + 20 * 60 + 20) * 1000000000L + 560000000L, -(20 * 3600 + 20 * 60 + 20) * 1000000000L - 560000000L,
                (20 * 3600 + 20 * 60 + 20) * 1000000000L + 550000000L, -(20 * 3600 + 20 * 60 + 20) * 1000000000L - 550000000L,
                (20 * 3600 + 20 * 60 + 21) * 1000000000L + 000000000L, -(20 * 3600 + 20 * 60 + 21) * 1000000000L - 000000000L})
            .column,
        to_type_3,
        "output3");
    ...
    ASSERT_COLUMN_EQ(
        output1_nullable, executeFunction(func_name, {input_nullable, createCastTypeConstColumn(makeNullable(to_type_1)->getName())}));
    ASSERT_COLUMN_EQ(
        output2_nullable, executeFunction(func_name, {input_nullable, createCastTypeConstColumn(makeNullable(to_type_2)->getName())}));
    ASSERT_COLUMN_EQ(
        output3_nullable, executeFunction(func_name, {input_nullable, createCastTypeConstColumn(makeNullable(to_type_3)->getName())}));

    // Test Const
    ColumnWithTypeAndName input_const(
        createConstColumn<DataTypeMyDuration::FieldType>(1, (20 * 3600 + 20 * 60 + 20) * 1000000000L + 999000000L).column,
        from_type,
        "input_const");
    ...
    ColumnWithTypeAndName output3_const(
        createConstColumn<DataTypeMyDuration::FieldType>(1, (20 * 3600 + 20 * 60 + 21) * 1000000000L + 000000000L).column,
        to_type_3,
        "output3_const");
...
try
{
    ...
    arg2_column = createColumn<Nullable<String>>({"%d/%c/%Y", "%d/%c/%Y"});
    result_column = ColumnWithTypeAndName(createConstColumn<Nullable<DataTypeMyDateTime::FieldType>>(2, {}).column,
        makeNullable(std::make_shared<DataTypeMyDateTime>(0)),
        "result");
    ASSERT_COLUMN_EQ(result_column, executeFunction("strToDateDatetime", arg1_column, arg2_column));
...
try
{
    ...
    auto nullable_from_column = createColumn<Nullable<String>>({"2012-12-12 12:12:12", "2012-12-12\t12:12:12", "2012-12-12\n12:12:12",
        "2012-12-12\v12:12:12", "2012-12-12\f12:12:12", "2012-12-12\r12:12:12"});
