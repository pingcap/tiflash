...
int benchEntry(const std::vector<std::string> & opts)
{
    ...
    try
    {
        ...
        if (algorithm_ == "xxh3")
        {
            algorithm = DB::DM::ChecksumAlgo::XXH3;
        }
        else if (algorithm_ == "crc32")
        {
            algorithm = DB::DM::ChecksumAlgo::CRC32;
        }
        else if (algorithm_ == "crc64")
        {
            algorithm = DB::DM::ChecksumAlgo::CRC64;
        }
        else if (algorithm_ == "city128")
        {
            algorithm = DB::DM::ChecksumAlgo::City128;
        }
        else if (algorithm_ == "none")
        {
            algorithm = DB::DM::ChecksumAlgo::None;
        }
        else
        {
