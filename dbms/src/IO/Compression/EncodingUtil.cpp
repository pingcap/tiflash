...
template size_t estimateRunLengthDecodedByteSize<UInt8>(const UInt8 *, UInt32);
template size_t estimateRunLengthDecodedByteSize<UInt16>(const UInt16 *, UInt32);
template size_t estimateRunLengthDecodedByteSize<UInt32>(const UInt32 *, UInt32);
template size_t estimateRunLengthDecodedByteSize<UInt64>(const UInt64 *, UInt32);
