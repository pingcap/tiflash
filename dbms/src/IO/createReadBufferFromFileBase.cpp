...
std::unique_ptr<ReadBufferFromFileBase> createReadBufferFromFileBase(FileProviderPtr & file_provider, const std::string & filename_, const EncryptionPath & encryption_path_,
