...
CompressedReadBufferFromFile::CompressedReadBufferFromFile(FileProviderPtr &file_provider, const std::string &path,
                                                           size_t estimated_size, size_t aio_threshold,
                                                           size_t buf_size)
    : BufferWithOwnMemory<ReadBuffer>(0),
