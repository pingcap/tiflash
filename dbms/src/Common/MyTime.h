...
Field parseMyDateTime(const String & str, int8_t fsp = 6, bool checkFormat = false);
Field parseMyDateTimeAndJudgeIsDate(const String & str, bool & is_date, int8_t fsp = 6, bool checkFormat = false);
