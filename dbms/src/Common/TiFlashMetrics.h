...
#define APPLY_FOR_METRICS(M, F)                                                                                                           \
    ...
    M(tiflash_storage_throughput_bytes, "Calculate the throughput of tasks of storage ", Gauge,                   /**/                    \
        F(type_write, {"type", "write"}),                                                                         /**/                    \
        F(type_delta_merge, {"type", "delta_merge"}),                                                             /**/                    \
        F(type_split, {"type", "split"}),                                                                         /**/                    \
        F(type_merge, {"type", "merge"}))                                                                         /**/                    \
    M(tiflash_storage_throughput_rows, "Calculate the throughput of tasks of storage ", Gauge,                    /**/                    \
        F(type_write, {"type", "write"}),                                                                         /**/                    \
        F(type_delta_merge, {"type", "delta_merge"}),                                                             /**/                    \
        F(type_split, {"type", "split"}),                                                                         /**/                    \
        F(type_merge, {"type", "merge"}))                                                                         /**/                    \
