...
public:
        ...
        , query_operator_spill_contexts(query_operator_spill_contexts_)
    {
        ...
        RUNTIME_CHECK_MSG(auto_memory_revoke_target_threshold >= 0 && auto_memory_revoke_trigger_threshold > 0,
        ...
        {
            LOG_WARNING(query_operator_spill_contexts->getLogger(), "Auto trigger threshold {} less than auto target threshold {}, not valid, use default value instead", auto_memory_revoke_trigger_threshold, auto_memory_revoke_target_threshold);
