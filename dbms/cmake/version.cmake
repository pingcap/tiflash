...
if (FORCE_TIFLASH_RELEASE_VERSION)
    message (STATUS "force set TIFLASH_RELEASE_VERSION to ${FORCE_TIFLASH_RELEASE_VERSION}")
    set (TIFLASH_RELEASE_VERSION ${FORCE_TIFLASH_RELEASE_VERSION})
endif()
