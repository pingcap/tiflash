...
if (NOT USE_INTERNAL_POCO_LIBRARY)
    find_package (Poco COMPONENTS Net NetSSL XML Crypto)
endif ()
...
elseif (NOT MISSING_INTERNAL_POCO_LIBRARY)
    ...
    set (ENABLE_PROMETHEUS 0 CACHE BOOL "")
    ...
    if (OPENSSL_FOUND)
        ...
        set (Poco_NetSSL_LIBRARY Poco::Net::SSL)
...
message(STATUS "Using Poco: include=${Poco_INCLUDE_DIRS}, libs=${Poco_Foundation_LIBRARY},${Poco_Util_LIBRARY},${Poco_Net_LIBRARY},${Poco_NetSSL_LIBRARY},${Poco_XML_LIBRARY},${Poco_Data_LIBRARY},${Poco_MongoDB_LIBRARY}; NetSSL=${Poco_NetSSL_FOUND}")
