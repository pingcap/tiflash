...
if(NOT EXISTS "${TiFlash_SOURCE_DIR}/contrib/tiflash-proxy/Makefile")
    message(FATAL_ERROR "submodule contrib/tiflash-proxy is missing. to fix try run: \n git submodule update --init")
endif()
...
message(STATUS "Using tiflash proxy: ${TIFLASH_PROXY_INCLUDE_DIR}, ${TIFLASH_PROXY_LIBRARY}")
