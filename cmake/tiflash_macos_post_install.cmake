...
execute_process(COMMAND sh -c "otool -L ${CMAKE_INSTALL_PREFIX}/tiflash | grep proxy | awk '{print \$1;}'" OUTPUT_VARIABLE _OLD_DEPENDENCY)
string(STRIP "${_OLD_DEPENDENCY}" OLD_DEPENDENCY)
