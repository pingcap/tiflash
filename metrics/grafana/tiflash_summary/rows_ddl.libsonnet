...
{
  row: rowObj
  .addPanel(schema_Internal_DDL_OPMP, gridPos=common.pos(12, 7))
  .addPanel(schema_Apply_OPMP, gridPos=common.pos(12, 7))
  .addPanel(schema_Apply_DurationP, gridPos=common.pos(12, 7))
  ,
  panels: [
    { panel: schema_Internal_DDL_OPMP, w: 12, h: 7 },
    { panel: schema_Apply_OPMP, w: 12, h: 7 },
    { panel: schema_Apply_DurationP, w: 12, h: 7 }
  ],
}
